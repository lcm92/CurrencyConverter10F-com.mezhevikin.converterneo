...
.method public final E(Lx0/i;)V
    ...
    invoke-direct {v3, v4, v1}, Lx0/a;-><init>(Ljava/lang/String;Lu8/e;)V
...
.method public final a(Lq0/na;Lo0/da;I)I
    ...
    invoke-virtual {p0, p1}, Lz/h;->z0(Ll5/b;)Lz/d;
    ...
    invoke-virtual {p2, p3, p1}, Lz/d;->a(ILl5/k;)I
...
.method public final c(Lq0/na;Lo0/da;I)I
    ...
    invoke-virtual {p2, p1}, Lz/d;->d(Ll5/k;)La5/s;
...
.method public final e(Lq0/fa;)V
    ...
    iget-object v1, v1, Lz/d;->n:Lz0/ca;
    ...
    invoke-static {v5, v6, v2, v3}, Lh7/b;->w(JJ)Lxa/d;

    move-result-object v2

    invoke-interface {v0}, Lya/p;->e()V

    invoke-static {v0, v2}, Lya/p;->u(Lya/p;Lxa/d;)V

    :cond_5
    :try_start_0
    iget-object v2, p0, Lz/h;->u:Lz0/fa;

    iget-object v2, v2, Lz0/fa;->a:Lz0/y;

    iget-object v3, v2, Lz0/y;->m:Lk5/h;

    if-nez v3, :cond_6

    sget-object v3, Lk5/h;->b:Lk5/h;

    :cond_6
    move-object v6, v3

    iget-object v3, v2, Lz0/y;->n:Lya/la;

    if-nez v3, :cond_7

    sget-object v3, Lya/la;->d:Lya/la;
    ...
    invoke-static/range {v1 .. v7}, Lz0/l;->h(Lz0/l;Lya/p;Lya/ha;FLya/la;Lk5/h;La0/c;)V

    goto :goto_7

    :cond_9
    iget-object v2, p0, Lz/h;->D:Laa/za;
    ...
    invoke-static/range {v1 .. v7}, Lz0/l;->g(Lz0/l;Lya/p;JLya/la;Lk5/h;La0/c;)V
    :try_end_0
...
.method public final h(Lo0/ga;Lo0/da;J)Lo0/fa;
    ...
    iget-object v4, v0, Lz/d;->b:Lz0/fa;

    iget-object v5, v0, Lz/d;->k:Ll5/b;

    invoke-static {v5}, Li4/h;->c(Ljava/lang/Object;)V

    iget-object v6, v0, Lz/d;->c:Le5/o;

    invoke-static {v2, v1, v4, v5, v6}, Lp1/h;->d(Lz/b;Ll5/k;Lz0/fa;Ll5/b;Le5/o;)Lz/b;
    ...
    :cond_0
    iget-object v2, v0, Lz/d;->n:Lz0/ca;
    ...
    :cond_1
    iget-object v4, v2, Lz0/ca;->b:Lz0/l;

    iget-object v5, v4, Lz0/l;->a:La5/s;

    invoke-virtual {v5}, La5/s;->b()Z
    ...
    iget-object v5, v2, Lz0/ba;->h:Ll5/k;
    ...
    :cond_3
    iget-wide v5, v2, Lz0/ba;->j:J

    invoke-static {p3, p4, v5, v6}, Ll5/a;->b(JJ)Z
    ...
    iget-wide v4, v2, Lz0/ba;->j:J

    invoke-static {p3, p4, v4, v5}, Ll5/a;->b(JJ)Z
    ...
    invoke-virtual {v0, v1, p3, p4, v2}, Lz/d;->e(Ll5/k;JLz0/l;)Lz0/ca;

    move-result-object p3

    iput-object p3, v0, Lz/d;->n:Lz0/ca;

    goto :goto_2

    :cond_8
    :goto_1
    invoke-virtual {v0, p3, p4, v1}, Lz/d;->b(JLl5/k;)Lz0/l;
    ...
    :goto_2
    iget-object p3, v0, Lz/d;->n:Lz0/ca;

    if-eqz p3, :cond_10

    iget-object p4, p3, Lz0/ca;->b:Lz0/l;

    iget-object p4, p4, Lz0/l;->a:La5/s;

    invoke-virtual {p4}, La5/s;->b()Z

    if-eqz v3, :cond_b

    const/4 p4, 0x2

    invoke-static {p0, p4}, Lq0/f;->t(Lq0/m;I)Lq0/za;
    ...
    iget-object v0, p3, Lz0/ca;->f:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p2, v2}, Lo5/o;-><init>(Lo0/na;I)V

    invoke-interface {p1, p3, p4, v0, v1}, Lo0/ga;->K(IILjava/util/Map;Lh4/c;)Lo0/fa;
...
.method public final y0()Lz/d;
    ...
    iget-object v3, p0, Lz/h;->u:Lz0/fa;

    iget-object v4, p0, Lz/h;->v:Le5/o;
    ...
    invoke-direct/range {v1 .. v9}, Lz/d;-><init>(Lz0/f;Lz0/fa;Le5/o;IZIILjava/util/List;)V
...
.method public final z0(Ll5/b;)Lz/d;
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lz/d;->c(Ll5/b;)V
