...
.method public static final a(Lra/q;Lfa/p;I)V
    .locals 5
    ...
    :cond_3
    :goto_2
    iget v0, p1, Lfa/p;->P:I

    invoke-static {p1, p0}, Lra/a;->d(Lfa/p;Lra/q;)Lra/q;
    ...
    invoke-static {p1, v3, v4}, Lfa/d;->Q(Lfa/p;Lh4/e;Ljava/lang/Object;)V
    ...
    :cond_5
    invoke-static {v0, p1, v0, v1}, Laa/m;->r(ILfa/p;ILq0/h;)V
...
.method public static final b(Lo0/ma;Lo0/na;Lo0/da;Ll5/k;IILra/d;)V
    .locals 6

    invoke-interface {p2}, Lo0/da;->r()Ljava/lang/Object;
    ...
    iget-object p2, p2, Lq/k;->t:Lra/i;
    ...
    :goto_2
    iget p2, p1, Lo0/na;->g:I

    iget p6, p1, Lo0/na;->h:I

    invoke-static {p2, p6}, Ll9/d;->b(II)J

    move-result-wide v1

    invoke-static {p4, p5}, Ll9/d;->b(II)J
    ...
    invoke-static {p0, p1, p2, p3}, Lo0/ma;->e(Lo0/ma;Lo0/na;J)V
...
.method public static final c(Z)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->h:Lra/i;

    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->i:Lra/i;

    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->j:Lra/i;
    ...
    sget-object v1, Lra/b;->l:Lra/i;

    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->m:Lra/i;

    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->n:Lra/i;

    invoke-static {v0, p0, v1}, Lq/n;->d(Ljava/util/HashMap;ZLra/i;)V

    sget-object v1, Lra/b;->o:Lra/i;
...
.method public static final d(Ljava/util/HashMap;ZLra/i;)V
    .locals 1

    new-instance v0, Lq/q;

    invoke-direct {v0, p2, p1}, Lq/q;-><init>(Lra/d;Z)V
...
.method public static final e(Lra/d;Z)Lo0/ea;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lq/q;-><init>(Lra/d;Z)V
