...
.method public constructor <init>(LF/X;)V
    ...
    iput-object v0, p1, LF/S;->c:Ljava/lang/Object;
    ...
    iput-object v0, p1, LF/S;->b:Ljava/lang/Object;
    ...
    iput-object v0, p1, LF/S;->d:Ljava/lang/Object;
    ...
    .line 12
    iput-object p1, p0, LF/l0;->i:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/view/Choreographer;Lr0/W;)V
    ...
    .line 3
    iput-object p2, p0, LF/l0;->i:Ljava/lang/Object;
...
.method public final x(Lh4/c;LY3/d;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LF/l0;->i:Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, p2}, Ls4/f;-><init>(ILY3/d;)V

    invoke-virtual {v1}, Ls4/f;->q()V

    new-instance p2, LF/B;

    invoke-direct {p2, v1, p0, p1}, LF/B;-><init>(Ls4/f;LF/l0;Lh4/c;)V

    if-eqz v0, :cond_3

    iget-object p1, v0, Lr0/W;->i:Landroid/view/Choreographer;

    iget-object v3, p0, LF/l0;->h:Ljava/lang/Object;
    ...
    :cond_3
    iget-object p1, p0, LF/l0;->h:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, LF/k0;-><init>(LF/l0;LY3/d;)V

    :goto_4
    iget-object p2, v0, LF/k0;->l:Ljava/lang/Object;

    sget-object v1, LZ3/a;->g:LZ3/a;

    iget v2, v0, LF/k0;->n:I
    ...
    :cond_6
    iget-object p1, v0, LF/k0;->k:Lh4/c;

    iget-object v2, v0, LF/k0;->j:LF/l0;
    ...
    iget-object p2, p0, LF/l0;->i:Ljava/lang/Object;

    check-cast p2, LF/S;

    iput-object p0, v0, LF/k0;->j:LF/l0;

    iput-object p1, v0, LF/k0;->k:Lh4/c;

    iput v4, v0, LF/k0;->n:I

    iget-object v2, p2, LF/S;->c:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    iget-boolean v5, p2, LF/S;->a:Z
    :try_end_1
    ...
    invoke-direct {v2, v4, v5}, Ls4/f;-><init>(ILY3/d;)V

    invoke-virtual {v2}, Ls4/f;->q()V

    iget-object v4, p2, LF/S;->c:Ljava/lang/Object;

    monitor-enter v4

    :try_start_2
    iget-object v5, p2, LF/S;->b:Ljava/lang/Object;
    ...
    invoke-direct {v4, p2, v5, v2}, LA/y;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :goto_6
    iget-object p2, v2, LF/l0;->h:Ljava/lang/Object;

    check-cast p2, LF/X;

    const/4 v2, 0x0

    iput-object v2, v0, LF/k0;->j:LF/l0;

    iput-object v2, v0, LF/k0;->k:Lh4/c;

    iput v3, v0, LF/k0;->n:I

    invoke-interface {p2, p1, v0}, LF/X;->x(Lh4/c;LY3/d;)Ljava/lang/Object;
