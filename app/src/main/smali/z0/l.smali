...
# direct methods
.method public constructor <init>(La5/s;JIZ)V
    .locals 20
    ...
    iput-object v1, v0, Lz0/l;->a:La5/s;

    move/from16 v2, p4

    iput v2, v0, Lz0/l;->b:I

    invoke-static/range {p2 .. p3}, Ll5/a;->j(J)I

    move-result v2

    if-nez v2, :cond_a

    invoke-static/range {p2 .. p3}, Ll5/a;->i(J)I
    ...
    iget-object v1, v1, La5/s;->g:Ljava/lang/Object;
    ...
    iget-object v15, v7, Lz0/o;->a:Lh5/d;

    invoke-static/range {p2 .. p3}, Ll5/a;->h(J)I

    move-result v8

    invoke-static/range {p2 .. p3}, Ll5/a;->c(J)Z

    move-result v9

    if-eqz v9, :cond_0

    invoke-static/range {p2 .. p3}, Ll5/a;->g(J)I
    ...
    invoke-direct/range {v14 .. v19}, Lz0/a;-><init>(Lh5/d;IZJ)V
    ...
    iget-object v5, v8, Lz0/a;->d:La5/ga;

    iget v9, v5, La5/ga;->g:I
    ...
    invoke-virtual {v11, v14, v15}, Lxa/d;->h(J)Lxa/d;
    ...
    invoke-static {v1, v8}, Lv8/q;->f0(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    iget-object v3, v0, Lz0/l;->a:La5/s;

    iget-object v3, v3, La5/s;->h:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lz0/l;->a:La5/s;

    iget-object v2, v2, La5/s;->h:Ljava/lang/Object;
    ...
    :cond_8
    invoke-static {v1, v3}, Lv8/k;->v0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method public static g(Lz0/l;Lya/p;JLya/la;Lk5/h;La0/c;)V
    .locals 12
    ...
    invoke-virtual/range {v4 .. v11}, Lz0/a;->f(Lya/p;JLya/la;Lk5/h;La0/c;I)V
...
.method public static h(Lz0/l;Lya/p;Lya/ha;FLya/la;Lk5/h;La0/c;)V
    .locals 16
    ...
    invoke-static/range {v0 .. v7}, Lh5/k;->a(Lz0/l;Lya/p;Lya/ha;FLya/la;Lk5/h;La0/c;I)V
    ...
    invoke-virtual {v0, v5, v6}, Lya/ka;->H(J)Landroid/graphics/Shader;
    ...
    new-instance v7, Lya/o;

    invoke-direct {v7, v0}, Lya/o;-><init>(Landroid/graphics/Shader;)V
    ...
    invoke-virtual/range {v5 .. v12}, Lz0/a;->g(Lya/p;Lya/ha;FLya/la;Lk5/h;La0/c;I)V
    ...
    invoke-interface {v7, v4, v6}, Lya/p;->q(FF)V
...
.method public final e(J)I
    ...
    iget v3, v0, La5/ga;->h:I

    sub-int/2addr v1, v3

    iget-object v3, v0, La5/ga;->f:Landroid/text/Layout;
    ...
    invoke-virtual {v0, v1}, La5/ga;->b(I)F
...
.method public final f(Lxa/d;ILaa/s;)J
    .locals 12
    ...
    sget-wide v6, Lz0/ea;->b:J

    :goto_0
    sget-wide v8, Lz0/ea;->b:J

    invoke-static {v6, v7, v8, v9}, Lz0/ea;->a(JJ)Z
    ...
    invoke-virtual {p1, v7, v8}, Lxa/d;->h(J)Lxa/d;

    move-result-object v7

    invoke-virtual {v6, v7, p2, p3}, Lz0/a;->c(Lxa/d;ILaa/s;)J
    ...
    :cond_2
    :goto_1
    sget-wide v10, Lz0/ea;->b:J

    invoke-static {v8, v9, v10, v11}, Lz0/ea;->a(JJ)Z
    ...
    invoke-virtual {p1, v9, v10}, Lxa/d;->h(J)Lxa/d;

    move-result-object v9

    invoke-virtual {v8, v9, p2, p3}, Lz0/a;->c(Lxa/d;ILaa/s;)J
    ...
    invoke-virtual {v1, p1, p2, p3}, Lz0/a;->c(Lxa/d;ILaa/s;)J
...
.method public final i(I)V
    ...
    iget-object v0, p0, Lz0/l;->a:La5/s;

    if-ltz p1, :cond_0

    iget-object v1, v0, La5/s;->i:Ljava/lang/Object;
    ...
    iget-object v0, v0, La5/s;->i:Ljava/lang/Object;
