...
.method public static A0(J)Z
    ...
    invoke-static {p0, p1, v0, v1}, LX/f;->a(JJ)Z
...
.method public final B0(J)J
    ...
    :goto_0
    invoke-static {p1, p2}, LL0/a;->f(J)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-static {p1, p2}, LL0/a;->e(J)Z
    ...
    invoke-static/range {v3 .. v9}, LL0/a;->a(JIIIII)J
    ...
    :cond_4
    iget-object v0, p0, LV/h;->t:Ld0/b;

    invoke-virtual {v0}, Ld0/b;->d()J

    move-result-wide v0

    invoke-static {v0, v1}, LV/h;->A0(J)Z
    ...
    :cond_5
    invoke-static {p1, p2}, LL0/a;->j(J)I

    move-result v2

    :goto_1
    invoke-static {v0, v1}, LV/h;->z0(J)Z
    ...
    :cond_6
    invoke-static {p1, p2}, LL0/a;->i(J)I
    ...
    :cond_7
    iget-object v2, p0, LV/h;->t:Ld0/b;

    invoke-virtual {v2}, Ld0/b;->d()J

    move-result-wide v2

    invoke-static {v2, v3}, LV/h;->A0(J)Z
    ...
    :goto_3
    iget-object v3, p0, LV/h;->t:Ld0/b;

    invoke-virtual {v3}, Ld0/b;->d()J

    move-result-wide v3

    invoke-static {v3, v4}, LV/h;->z0(J)Z
    ...
    :cond_b
    iget-object v4, p0, LV/h;->w:Lo0/I;
...
.method public final a(Lq0/N;Lo0/D;I)I
    ...
    invoke-virtual {p0, v0, v1}, LV/h;->B0(J)J
...
.method public final e(Lq0/F;)V
    ...
    :cond_3
    iget-object v2, p0, LV/h;->w:Lo0/I;
    ...
    invoke-interface/range {v8 .. v13}, LR/d;->a(JJLL0/k;)J
    ...
    iget-object v1, v3, La0/b;->h:LE0/l;

    iget-object v1, v1, LE0/l;->h:Ljava/lang/Object;

    check-cast v1, LA/Z;

    invoke-virtual {v1, v2, v0}, LA/Z;->r(FF)V

    :try_start_0
    iget-object v4, p0, LV/h;->t:Ld0/b;

    iget v8, p0, LV/h;->x:F

    iget-object v9, p0, LV/h;->y:LY/l;

    move-object v5, p1

    invoke-virtual/range {v4 .. v9}, Ld0/b;->c(Lq0/F;JFLY/l;)V
    :try_end_0
...
.method public final h(Lo0/G;Lo0/D;J)Lo0/F;
    ...
    invoke-virtual {p0, p3, p4}, LV/h;->B0(J)J
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, LV/h;->t:Ld0/b;
