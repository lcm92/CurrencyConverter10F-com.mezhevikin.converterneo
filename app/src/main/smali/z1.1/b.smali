...
.method public final b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, LE0/l;->z(Ljava/lang/String;)V

    :cond_5
    return-void
.end method

.method public final varargs c([LE1/i;)V
    .locals 11
    ...
    invoke-direct {v2, v1}, LF1/f;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    iget-object v8, v6, LE1/i;->a:Ljava/lang/String;

    invoke-virtual {v7, v8}, LE1/j;->h(Ljava/lang/String;)LE1/i;
    ...
    iget-object v6, v6, LE1/i;->a:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->k()LE0/l;

    move-result-object v7

    iget-object v8, v6, LE1/i;->a:Ljava/lang/String;

    invoke-virtual {v7, v8}, LE0/l;->p(Ljava/lang/String;)LE1/d;

    move-result-object v7

    if-eqz v7, :cond_2

    iget v8, v7, LE1/d;->b:I
    ...
    invoke-virtual {v2, v8}, LF1/f;->a(I)I
    ...
    iget-object v9, v6, LE1/i;->a:Ljava/lang/String;

    invoke-direct {v7, v9, v8}, LE1/d;-><init>(Ljava/lang/String;I)V

    iget-object v9, v0, Lw1/k;->e:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v9}, Landroidx/work/impl/WorkDatabase;->k()LE0/l;

    move-result-object v9

    invoke-virtual {v9, v7}, LE0/l;->s(LE1/d;)V

    :cond_3
    invoke-virtual {p0, v6, v8}, Lz1/b;->e(LE1/i;I)V
...
.method public final e(LE1/i;I)V
    .locals 11
    ...
    iget-object v2, p1, LE1/i;->j:Lv1/c;
    ...
    iget-object v5, p1, LE1/i;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v3}, LA0/y;->m(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    invoke-static {v1}, LA0/y;->l(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-static {v1}, LA0/m;->n(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-object v2, p1, LE1/i;->a:Ljava/lang/String;
    ...
    iget-boolean v1, p1, LE1/i;->q:Z

    if-eqz v1, :cond_e

    iget v1, p1, LE1/i;->r:I

    if-ne v1, v7, :cond_e

    iput-boolean v8, p1, LE1/i;->q:Z

    iget-object v1, p1, LE1/i;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2}, Lz1/b;->e(LE1/i;I)V
    :try_end_0
    ...
    invoke-virtual {v2}, LE1/j;->d()Ljava/util/ArrayList;
