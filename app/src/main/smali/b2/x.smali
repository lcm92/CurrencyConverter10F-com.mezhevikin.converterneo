...
.method public final c()Lb2/wa;
    ...
    instance-of v3, v2, Lb2/wa;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lb2/wa;

    goto :goto_0

    :cond_1
    new-instance v2, Lb2/wa;

    invoke-direct {v2, v1}, Lb2/wa;-><init>(Landroid/os/IBinder;)V
...
.method public final m()Lb2/za;
    ...
    instance-of v3, v2, Lb2/za;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lb2/za;

    goto :goto_0

    :cond_1
    new-instance v2, Lb2/xa;

    invoke-direct {v2, v1}, Lb2/xa;-><init>(Landroid/os/IBinder;)V
