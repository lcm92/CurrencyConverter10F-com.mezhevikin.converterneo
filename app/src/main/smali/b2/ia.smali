...
# direct methods
.method public static asInterface(Landroid/os/IBinder;)Lb2/ja;
    .locals 3
    ...
    instance-of v2, v1, Lb2/ja;

    if-eqz v2, :cond_1

    check-cast v1, Lb2/ja;

    return-object v1

    :cond_1
    new-instance v1, Lb2/ha;
...
.method public final h(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_0
    invoke-interface {p0}, Lb2/ja;->getAdapterCreator()Lw2/sa;
    ...
    :cond_1
    invoke-interface {p0}, Lb2/ja;->getLiteSdkVersion()Lb2/k0;
