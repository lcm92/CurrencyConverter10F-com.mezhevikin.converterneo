...
.method public static b(Landroid/content/Context;Lb2/d0;)Lb2/w0;
    ...
    iget-object v1, v1, Lb2/i0;->g:Ly6/m;
    ...
    iget-object v1, v1, Ly6/m;->a:Ljava/util/ArrayList;
...
.method public a(Landroid/os/IBinder;)Ljava/lang/Object;
    ...
    check-cast v1, Lb2/na;

    goto :goto_1

    :cond_3
    new-instance v1, Lb2/na;

    invoke-direct {v1, p1}, Lb2/na;-><init>(Landroid/os/IBinder;)V
    ...
    instance-of v3, v2, Lb2/va;

    if-eqz v3, :cond_9

    move-object v1, v2

    check-cast v1, Lb2/va;

    goto :goto_4

    :cond_9
    new-instance v2, Lb2/va;
