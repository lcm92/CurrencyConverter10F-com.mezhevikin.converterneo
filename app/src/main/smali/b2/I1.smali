...
# direct methods
.method public static asInterface(Landroid/os/IBinder;)Lb2/J1;
    .locals 3
    ...
    instance-of v2, v1, Lb2/J1;

    if-eqz v2, :cond_1

    check-cast v1, Lb2/J1;
...
.method public final h(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_0
    invoke-interface {p0}, Lb2/J1;->getAdapterCreator()Lw2/S1;
    ...
    :cond_1
    invoke-interface {p0}, Lb2/J1;->getLiteSdkVersion()Lb2/k0;
