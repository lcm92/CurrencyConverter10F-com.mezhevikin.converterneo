...
.method public final b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Le5/l;->z(Ljava/lang/String;)V

    :cond_5
    return-void
.end method

.method public final varargs c([Le6/i;)V
    .locals 11
    ...
    invoke-direct {v2, v1}, Lf6/f;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    :try_start_0
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->n()Le6/j;

    move-result-object v7

    iget-object v8, v6, Le6/i;->a:Ljava/lang/String;

    invoke-virtual {v7, v8}, Le6/j;->h(Ljava/lang/String;)Le6/i;
    ...
    iget-object v6, v6, Le6/i;->a:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->k()Le5/l;

    move-result-object v7

    iget-object v8, v6, Le6/i;->a:Ljava/lang/String;

    invoke-virtual {v7, v8}, Le5/l;->p(Ljava/lang/String;)Le6/d;

    move-result-object v7

    if-eqz v7, :cond_2

    iget v8, v7, Le6/d;->b:I
    ...
    invoke-virtual {v2, v8}, Lf6/f;->a(I)I
    ...
    iget-object v9, v6, Le6/i;->a:Ljava/lang/String;

    invoke-direct {v7, v9, v8}, Le6/d;-><init>(Ljava/lang/String;I)V

    iget-object v9, v0, Lw1/k;->e:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v9}, Landroidx/work/impl/WorkDatabase;->k()Le5/l;

    move-result-object v9

    invoke-virtual {v9, v7}, Le5/l;->s(Le6/d;)V

    :cond_3
    invoke-virtual {p0, v6, v8}, Lz1/b;->e(Le6/i;I)V
...
.method public final e(Le6/i;I)V
    .locals 11
    ...
    iget-object v2, p1, Le6/i;->j:Lv1/c;
    ...
    iget-object v5, p1, Le6/i;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v3}, La5/y;->m(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    invoke-static {v3}, Lk/pa;->l(I)Ljava/lang/String;
    ...
    invoke-static {v1}, La5/y;->l(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-static {v1}, La5/m;->n(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-object v2, p1, Le6/i;->a:Ljava/lang/String;
    ...
    iget-boolean v1, p1, Le6/i;->q:Z

    if-eqz v1, :cond_e

    iget v1, p1, Le6/i;->r:I

    if-ne v1, v7, :cond_e

    iput-boolean v8, p1, Le6/i;->q:Z
    ...
    invoke-virtual {p0, p1, p2}, Lz1/b;->e(Le6/i;I)V
    :try_end_0
    ...
    invoke-virtual {v2}, Le6/j;->d()Ljava/util/ArrayList;
