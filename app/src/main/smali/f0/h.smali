...
.method public final a(LF0/j;)V
    ...
    :goto_0
    iget v3, p0, LF0/h;->a:I

    if-ge v1, v3, :cond_2

    add-int/lit8 v3, v2, 0x1

    iget v4, p1, LF0/j;->b:I
    ...
    invoke-virtual {p1, v4}, LF0/j;->b(I)C

    move-result v4

    iget v5, p1, LF0/j;->b:I

    sub-int/2addr v5, v3

    invoke-virtual {p1, v5}, LF0/j;->b(I)C
    ...
    iget-object v5, p1, LF0/j;->a:LB0/f;
    ...
    :cond_5
    iget v0, p1, LF0/j;->c:I

    add-int/2addr v1, v0

    invoke-virtual {p1, v0, v1}, LF0/j;->a(II)V

    iget v0, p1, LF0/j;->b:I

    sub-int v1, v0, v2

    invoke-virtual {p1, v1, v0}, LF0/j;->a(II)V
