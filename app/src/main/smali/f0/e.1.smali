...
# direct methods
.method public constructor <init>(Lr0/u;LE0/l;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LF0/e;->a:Lr0/u;

    iput-object p2, p0, LF0/e;->b:LE0/l;
    ...
    sget-object p1, LF0/d;->j:LF0/d;

    iput-object p1, p0, LF0/e;->m:Li4/i;

    new-instance p1, Landroid/view/inputmethod/CursorAnchorInfo$Builder;

    invoke-direct {p1}, Landroid/view/inputmethod/CursorAnchorInfo$Builder;-><init>()V

    iput-object p1, p0, LF0/e;->p:Landroid/view/inputmethod/CursorAnchorInfo$Builder;

    invoke-static {}, LY/B;->a()[F

    move-result-object p1

    iput-object p1, p0, LF0/e;->q:[F

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, LF0/e;->r:Landroid/graphics/Matrix;
...
.method public final a()V
    ...
    iget-object v1, v0, LF0/e;->b:LE0/l;

    iget-object v2, v1, LE0/l;->i:Ljava/lang/Object;
    ...
    iget-object v1, v1, LE0/l;->h:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v3, v0, LF0/e;->m:Li4/i;

    new-instance v4, LY/B;

    iget-object v5, v0, LF0/e;->q:[F

    invoke-direct {v4, v5}, LY/B;-><init>([F)V

    invoke-interface {v3, v4}, Lh4/c;->j(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v3, v0, LF0/e;->a:Lr0/u;

    invoke-virtual {v3}, Lr0/u;->B()V

    iget-object v4, v3, Lr0/u;->R:[F

    invoke-static {v5, v4}, LY/B;->g([F[F)V
    ...
    invoke-static {v3, v4, v6}, LY/B;->i([FFF)V

    invoke-static {v5, v3}, Lr0/L;->v([F[F)V

    iget-object v3, v0, LF0/e;->r:Landroid/graphics/Matrix;

    invoke-static {v3, v5}, LY/H;->w(Landroid/graphics/Matrix;[F)V

    iget-object v4, v0, LF0/e;->j:LF0/w;

    invoke-static {v4}, Li4/h;->c(Ljava/lang/Object;)V

    iget-object v5, v0, LF0/e;->l:LC/q;

    invoke-static {v5}, Li4/h;->c(Ljava/lang/Object;)V

    iget-object v6, v0, LF0/e;->k:Lz0/C;

    invoke-static {v6}, Li4/h;->c(Ljava/lang/Object;)V

    iget-object v7, v0, LF0/e;->n:LX/d;

    invoke-static {v7}, Li4/h;->c(Ljava/lang/Object;)V

    iget-object v8, v0, LF0/e;->o:LX/d;

    invoke-static {v8}, Li4/h;->c(Ljava/lang/Object;)V

    iget-boolean v9, v0, LF0/e;->f:Z

    iget-boolean v10, v0, LF0/e;->g:Z

    iget-boolean v11, v0, LF0/e;->h:Z

    iget-boolean v12, v0, LF0/e;->i:Z

    iget-object v15, v0, LF0/e;->p:Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    :cond_1
    invoke-virtual {v5, v3}, LC/q;->a(I)I

    invoke-virtual {v6, v3}, Lz0/C;->c(I)LX/d;
    ...
    invoke-static {v7, v14, v0}, Li0/c;->u(LX/d;FF)Z

    move-result v0

    iget v13, v9, LX/d;->d:F

    invoke-static {v7, v14, v13}, Li0/c;->u(LX/d;FF)Z

    move-result v13

    invoke-virtual {v6, v3}, Lz0/C;->a(I)LK0/f;
    ...
    iget-object v3, v4, LF0/w;->c:Lz0/E;
    ...
    invoke-virtual {v5, v9}, LC/q;->a(I)I

    invoke-virtual {v5, v0}, LC/q;->a(I)I
    ...
    invoke-virtual {v5, v4}, LC/q;->a(I)I
    ...
    :goto_9
    invoke-static {v7, v15, v14}, Li0/c;->u(LX/d;FF)Z

    move-result v16

    if-eqz v16, :cond_f

    invoke-static {v7, v13, v10}, Li0/c;->u(LX/d;FF)Z
    ...
    :goto_c
    invoke-virtual {v6, v4}, Lz0/C;->a(I)LK0/f;
    ...
    invoke-static {v2, v8}, LF0/b;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;LX/d;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static {v2, v6, v7}, LF0/c;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Lz0/C;LX/d;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-interface/range {v22 .. v22}, LU3/f;->getValue()Ljava/lang/Object;
