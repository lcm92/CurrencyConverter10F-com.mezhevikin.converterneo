...
# direct methods
.method public constructor <init>(LF0/w;LA/Z;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LF0/s;->a:LA/Z;

    iput-boolean p3, p0, LF0/s;->b:Z

    iput-object p1, p0, LF0/s;->d:LF0/w;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, LF0/s;->g:Ljava/util/ArrayList;

    const/4 p1, 0x1

    iput-boolean p1, p0, LF0/s;->h:Z
...
.method public final a(LF0/i;)V
    ...
    :try_start_0
    iget-object v0, p0, LF0/s;->g:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0}, LF0/s;->b()Z
...
.method public final b()Z
    ...
    iget-object v2, p0, LF0/s;->a:LA/Z;

    iget-object v2, v2, LA/Z;->h:Ljava/lang/Object;

    check-cast v2, LF0/z;

    iget-object v2, v2, LF0/z;->e:Li4/i;
...
.method public final c(I)V
    ...
    invoke-virtual {p0, v0}, LF0/s;->sendKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public final closeConnection()V
    ...
    iput-boolean v0, p0, LF0/s;->h:Z

    iget-object v1, p0, LF0/s;->a:LA/Z;

    iget-object v1, v1, LA/Z;->h:Ljava/lang/Object;

    check-cast v1, LF0/z;

    iget-object v2, v1, LF0/z;->i:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, LF0/z;->i:Ljava/util/ArrayList;
...
.method public final commitText(Ljava/lang/CharSequence;I)Z
    ...
    invoke-virtual {p0, v1}, LF0/s;->a(LF0/i;)V
...
.method public final deleteSurroundingText(II)Z
    ...
    invoke-virtual {p0, v0}, LF0/s;->a(LF0/i;)V
...
.method public final getCursorCapsMode(I)I
    ...
    iget-object v0, p0, LF0/s;->d:LF0/w;
...
.method public final getExtractedText(Landroid/view/inputmethod/ExtractedTextRequest;I)Landroid/view/inputmethod/ExtractedText;
    ...
    :cond_1
    iput v1, p0, LF0/s;->e:I

    :cond_2
    iget-object p1, p0, LF0/s;->d:LF0/w;

    invoke-static {p1}, Lo4/j;->P(LF0/w;)Landroid/view/inputmethod/ExtractedText;
...
.method public final getTextAfterCursor(II)Ljava/lang/CharSequence;
    ...
    iget-object p2, p0, LF0/s;->d:LF0/w;
...
.method public final performContextMenuAction(I)Z
    ...
    invoke-virtual {p0, p1}, LF0/s;->c(I)V
    ...
    iget-object v1, p0, LF0/s;->d:LF0/w;
    ...
    invoke-virtual {p0, p1}, LF0/s;->a(LF0/i;)V
...
.method public final performEditorAction(I)Z
    ...
    iget-object v1, v1, LF0/z;->f:Li4/i;
...
.method public final requestCursorUpdates(I)Z
    ...
    :goto_5
    iget-object v4, p0, LF0/s;->a:LA/Z;

    iget-object v4, v4, LA/Z;->h:Ljava/lang/Object;

    check-cast v4, LF0/z;

    iget-object v4, v4, LF0/z;->l:LF0/e;

    iget-object v7, v4, LF0/e;->c:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    iput-boolean v5, v4, LF0/e;->f:Z

    iput-boolean v6, v4, LF0/e;->g:Z

    iput-boolean v2, v4, LF0/e;->h:Z

    iput-boolean p1, v4, LF0/e;->i:Z

    if-eqz v0, :cond_9

    iput-boolean v1, v4, LF0/e;->e:Z

    iget-object p1, v4, LF0/e;->j:LF0/w;
...
.method public final sendKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, LF0/s;->a:LA/Z;

    iget-object v0, v0, LA/Z;->h:Ljava/lang/Object;

    check-cast v0, LF0/z;

    iget-object v0, v0, LF0/z;->j:Ljava/lang/Object;
