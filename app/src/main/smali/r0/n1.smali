...
.method public static final a(Lr0/a;Lfa/r;Lna/a;)Lr0/l1;
    .locals 6
    ...
    invoke-static {v2}, Ls4/y;->b(Ly8/i;)Lx4/d;

    move-result-object v2

    new-instance v4, Lr0/n0;

    invoke-direct {v4, v0, v3}, Lr0/n0;-><init>(Lu4/d;Ly8/d;)V

    const/4 v5, 0x3

    invoke-static {v2, v3, v1, v4, v5}, Ls4/y;->u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;

    new-instance v2, Lj3/fa;

    const/16 v4, 0x10

    invoke-direct {v2, v4, v0}, Lj3/fa;-><init>(ILjava/lang/Object;)V
    ...
    :try_start_0
    sget-object v4, Lpa/p;->h:Ljava/lang/Object;

    invoke-static {v4, v2}, Lv8/k;->w0(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v2

    sput-object v2, Lpa/p;->h:Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {p1}, Lfa/r;->h()Ly8/i;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lr0/u;-><init>(Landroid/content/Context;Ly8/i;)V
    ...
    invoke-direct {p0, v1}, Lo2/b;-><init>(Lq0/da;)V

    new-instance v1, Lfa/t;

    invoke-direct {v1, p1, p0}, Lfa/t;-><init>(Lfa/r;Lo2/b;)V
    ...
    invoke-direct {v3, v0, v1}, Lr0/l1;-><init>(Lr0/u;Lfa/t;)V
    ...
    :cond_5
    invoke-virtual {v3, p2}, Lr0/l1;->e(Lna/a;)V
    ...
    invoke-virtual {v0, p0}, Lr0/u;->setCoroutineContext(Ly8/i;)V
