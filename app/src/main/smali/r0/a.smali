...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p3}, Laa/s;-><init>(I)V
...
.method private final setParentContext(Lfa/r;)V
    .locals 1

    iget-object v0, p0, Lr0/a;->j:Lfa/r;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lr0/a;->j:Lfa/r;
...
# virtual methods
.method public abstract a(ILfa/p;)V
.end method
...
.method public final c()V
    ...
    invoke-virtual {p0}, Lr0/a;->f()Lfa/r;
    ...
    invoke-direct {v3, v4, p0}, Lca/v;-><init>(ILjava/lang/Object;)V

    new-instance v4, Lna/a;

    const v5, -0x271bffc0

    invoke-direct {v4, v5, v3, v1}, Lna/a;-><init>(ILjava/lang/Object;Z)V

    invoke-static {p0, v2, v4}, Lr0/n1;->a(Lr0/a;Lfa/r;Lna/a;)Lr0/l1;
...
.method public final f()Lfa/r;
    .locals 13

    const/4 v0, 0x2

    iget-object v1, p0, Lr0/a;->j:Lfa/r;

    if-nez v1, :cond_15

    invoke-static {p0}, Lr0/h1;->b(Landroid/view/View;)Lfa/r;
    ...
    invoke-static {v1}, Lr0/h1;->b(Landroid/view/View;)Lfa/r;
    ...
    instance-of v3, v1, Lfa/z0;

    if-eqz v3, :cond_3

    move-object v3, v1

    check-cast v3, Lfa/z0;

    iget-object v3, v3, Lfa/z0;->r:Lv4/pa;

    invoke-virtual {v3}, Lv4/pa;->getValue()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lfa/t0;

    sget-object v4, Lfa/t0;->h:Lfa/t0;
    ...
    :cond_9
    :goto_7
    invoke-static {v9}, Lr0/h1;->b(Landroid/view/View;)Lfa/r;

    move-result-object v1

    if-nez v1, :cond_11

    sget-object v1, Lr0/ya0;->a:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lr0/wa0;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v1, Ly8/j;->g:Ly8/j;

    sget-object v3, Lr0/wa;->s:Lu8/n;
    ...
    :goto_8
    invoke-interface {v3, v1}, Ly8/i;->f(Ly8/i;)Ly8/i;

    move-result-object v3

    sget-object v4, Lfa/wa;->h:Lfa/wa;

    invoke-interface {v3, v4}, Ly8/i;->t(Ly8/h;)Ly8/g;

    move-result-object v4

    check-cast v4, Lfa/xa;

    const/4 v10, 0x0

    if-eqz v4, :cond_b

    new-instance v5, Lfa/l0;

    invoke-direct {v5, v4}, Lfa/l0;-><init>(Lfa/xa;)V

    iget-object v4, v5, Lfa/l0;->i:Ljava/lang/Object;

    check-cast v4, Lfa/sa;

    iget-object v6, v4, Lfa/sa;->c:Ljava/lang/Object;

    monitor-enter v6

    :try_start_0
    iput-boolean v10, v4, Lfa/sa;->a:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v1, v4}, Ly8/i;->f(Ly8/i;)Ly8/i;

    move-result-object v1

    new-instance v11, Lfa/z0;

    invoke-direct {v11, v1}, Lfa/z0;-><init>(Ly8/i;)V

    iget-object v3, v11, Lfa/z0;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean v4, v11, Lfa/z0;->q:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    monitor-exit v3

    invoke-static {v1}, Ls4/y;->b(Ly8/i;)Lx4/d;
    ...
    new-instance v3, Lr0/za0;

    invoke-direct {v3, v9, v11}, Lr0/za0;-><init>(Landroid/view/View;Lfa/z0;)V
    ...
    invoke-direct/range {v3 .. v8}, Lr0/e1;-><init>(Lx4/d;Lfa/l0;Lfa/z0;Li4/s;Landroid/view/View;)V
    ...
    sget-object v1, Ls4/sa;->g:Ls4/sa;
    ...
    new-instance v4, Lr0/xa0;

    invoke-direct {v4, v11, v9, v2}, Lr0/xa0;-><init>(Lfa/z0;Landroid/view/View;Ly8/d;)V

    invoke-static {v1, v3, v10, v4, v0}, Ls4/y;->u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;
    ...
    :goto_b
    iget-object v0, v1, Lfa/z0;->r:Lv4/pa;
...
.method public final setParentCompositionContext(Lfa/r;)V
    .locals 0

    invoke-direct {p0, p1}, Lr0/a;->setParentContext(Lfa/r;)V
...
.method public final setViewCompositionStrategy(Lr0/na0;)V
    .locals 3
