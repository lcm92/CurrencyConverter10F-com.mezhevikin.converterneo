...
.method public final j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lw/d0;->i:Lw/da;
    ...
    iput-object v4, v1, Lw/da;->a:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object v5, v1, Lw/da;->a:Ljava/lang/Integer;

    if-eqz v5, :cond_2

    iput-object v2, v1, Lw/da;->a:Ljava/lang/Integer;
    ...
    invoke-direct {v4, v1, v3}, Lf5/a;-><init>(Ljava/lang/String;I)V
    ...
    :goto_1
    iget-object v1, v0, Lw/d0;->f:Laa/k0;
    ...
    :cond_7
    iget-object v2, v0, Lw/d0;->j:Lw/ja;

    invoke-interface {v2, p1}, Lw/ja;->o(Landroid/view/KeyEvent;)I
    ...
    invoke-direct {v4, p1, v0, v2}, Lfa/r0;-><init>(ILw/d0;Li4/o;)V

    new-instance p1, Laa/wa;

    iget-object v5, v0, Lw/d0;->a:Lw/qa;

    invoke-virtual {v5}, Lw/qa;->d()Lw/p0;

    move-result-object v5

    iget-object v6, v0, Lw/d0;->c:Lf5/w;

    iget-object v7, v0, Lw/d0;->g:Lca/q;

    invoke-direct {p1, v6, v7, v5, v1}, Laa/wa;-><init>(Lf5/w;Lca/q;Lw/p0;Laa/k0;)V

    invoke-virtual {v4, p1}, Lfa/r0;->j(Ljava/lang/Object;)Ljava/lang/Object;

    iget-wide v4, p1, Laa/wa;->f:J

    iget-wide v7, v6, Lf5/w;->b:J

    invoke-static {v4, v5, v7, v8}, Lz0/ea;->a(JJ)Z

    move-result v1

    if-eqz v1, :cond_9

    iget-object v1, p1, Laa/wa;->g:Lz0/f;

    iget-object v4, v6, Lf5/w;->a:Lz0/f;
    ...
    iget-object p1, p1, Laa/wa;->g:Lz0/f;

    const/4 v1, 0x4

    invoke-static {v6, p1, v4, v5, v1}, Lf5/w;->a(Lf5/w;Lz0/f;JI)Lf5/w;
    ...
    invoke-static {v1}, Lya/ha;->A(Lxa/d;)Landroid/graphics/Rect;
    ...
    invoke-static {v0, p1, v1}, Lwa/d;->E(Landroid/view/View;Ljava/lang/Integer;Landroid/graphics/Rect;)Z
    ...
    iget-object v0, v0, Lr0/u;->v0:Lha/d;

    invoke-virtual {v0, p1}, Lha/d;->i(Ljava/lang/Object;)Z
