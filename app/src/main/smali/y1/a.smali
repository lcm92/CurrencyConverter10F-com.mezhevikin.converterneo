...
.method public static b(Landroid/content/Context;Lw1/k;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->k()Le6/l;

    move-result-object v0

    invoke-virtual {v0, p2}, Le6/l;->p(Ljava/lang/String;)Le7/d;
    ...
    invoke-direct {v8, v4, v9, v10}, Le7/c;-><init>(Ljava/lang/String;J)V

    invoke-virtual {v7, v8}, Ly/s;->s(Le7/c;)V
    ...
    invoke-direct {p1, p2, v5}, Le7/d;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v0, p1}, Le6/l;->s(Le7/d;)V
