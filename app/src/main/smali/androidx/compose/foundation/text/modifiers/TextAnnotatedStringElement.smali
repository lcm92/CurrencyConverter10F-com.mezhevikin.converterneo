...
.field public final i:Laa/za;


# direct methods
.method public constructor <init>(Lz0/f;Lz0/fa;Le5/o;Lh4/c;IZIILaa/za;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->b:Lz0/fa;

    iput-object p3, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;
    ...
    iput-object p9, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->i:Laa/za;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p1, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->i:Laa/za;

    iget-object v3, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->i:Laa/za;
    ...
    :cond_3
    iget-object v1, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->b:Lz0/fa;

    iget-object v3, p1, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->b:Lz0/fa;
    ...
    :cond_5
    iget-object v3, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;

    iget-object v4, p1, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->b:Lz0/fa;
    ...
    iget-object v0, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;
...
.method public final j()Lra/p;
    ...
    iput-object v1, v0, Lz/h;->u:Lz0/fa;

    iget-object v1, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;

    iput-object v1, v0, Lz/h;->v:Le5/o;
    ...
    iget-object v2, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->i:Laa/za;

    iput-object v2, v0, Lz/h;->D:Laa/za;
...
.method public final k(Lra/p;)V
    ...
    iget-object v0, p1, Lz/h;->D:Laa/za;

    iget-object v1, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->i:Laa/za;

    invoke-static {v1, v0}, Li4/h;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    iput-object v1, p1, Lz/h;->D:Laa/za;
    ...
    iget-object v0, p1, Lz/h;->u:Lz0/fa;

    if-eq v1, v0, :cond_0

    iget-object v4, v1, Lz0/fa;->a:Lz0/y;
    ...
    :cond_7
    iget-object v5, p1, Lz/h;->u:Lz0/fa;

    invoke-virtual {v5, v1}, Lz0/fa;->c(Lz0/fa;)Z

    move-result v5

    xor-int/2addr v5, v3

    iput-object v1, p1, Lz/h;->u:Lz0/fa;
    ...
    :cond_b
    iget-object v1, p1, Lz/h;->v:Le5/o;

    iget-object v7, p0, Landroidx/compose/foundation/text/modifiers/TextAnnotatedStringElement;->c:Le5/o;
    ...
    iput-object v7, p1, Lz/h;->v:Le5/o;
    ...
    iget-object v7, p1, Lz/h;->u:Lz0/fa;

    iget-object v8, p1, Lz/h;->v:Le5/o;
    ...
    iput-object v7, v1, Lz/d;->b:Lz0/fa;

    iput-object v8, v1, Lz/d;->c:Le5/o;
    ...
    iput-object v4, v1, Lz/d;->l:La5/s;

    iput-object v4, v1, Lz/d;->n:Lz0/ca;
