...
.field public final synthetic h:Lpa/s;

.field public final synthetic i:Lj1/h;


# direct methods
.method public synthetic constructor <init>(Lpa/s;Lj1/h;Z)V
    .locals 0
    ...
    iput-object p1, p0, Lk1/m;->h:Lpa/s;
...
.method public final c(Landroidx/lifecycle/t;Landroidx/lifecycle/n;)V
    ...
    iget-object v1, p0, Lk1/m;->h:Lpa/s;

    if-eqz v0, :cond_0

    invoke-virtual {v1, p1}, Lpa/s;->contains(Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {v1, p1}, Lpa/s;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, p1}, Lpa/s;->remove(Ljava/lang/Object;)Z
