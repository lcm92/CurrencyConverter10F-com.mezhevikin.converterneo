...
.method public constructor <init>(Ljava/util/List;JJI)V
    ...
    invoke-direct {p0}, Lya/ka;-><init>()V

    iput-object p1, p0, Lya/aa;->g:Ljava/util/List;

    iput-wide p2, p0, Lya/aa;->h:J

    iput-wide p4, p0, Lya/aa;->i:J

    iput p6, p0, Lya/aa;->j:I
...
.method public final H(J)Landroid/graphics/Shader;
    ...
    iget-object v0, p0, Lya/aa;->g:Ljava/util/List;
    ...
    :cond_4
    iget p1, p0, Lya/aa;->j:I

    invoke-static {p1, p2}, Lya/ha;->t(II)Z
    ...
    :cond_6
    invoke-static {p1, v4}, Lya/ha;->t(II)Z
    ...
    sget-object p1, Lya/pa;->a:Lya/pa;

    invoke-virtual {p1}, Lya/pa;->b()Landroid/graphics/Shader$TileMode;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    check-cast p1, Lya/aa;

    iget-object v1, p1, Lya/aa;->g:Ljava/util/List;

    iget-object v3, p0, Lya/aa;->g:Ljava/util/List;
    ...
    :cond_3
    iget-wide v3, p0, Lya/aa;->h:J

    iget-wide v5, p1, Lya/aa;->h:J
    ...
    :cond_4
    iget-wide v3, p0, Lya/aa;->i:J

    iget-wide v5, p1, Lya/aa;->i:J
    ...
    :cond_5
    iget v1, p0, Lya/aa;->j:I

    iget p1, p1, Lya/aa;->j:I

    invoke-static {v1, p1}, Lya/ha;->t(II)Z
...
.method public final hashCode()I
    ...
    iget-wide v1, p0, Lya/aa;->h:J

    const/16 v3, 0x1f

    invoke-static {v0, v3, v1, v2}, Lk/pa;->b(IIJ)I

    move-result v0

    iget-wide v1, p0, Lya/aa;->i:J
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lxa/c;->j(J)Ljava/lang/String;
    ...
    iget-object v2, p0, Lya/aa;->g:Ljava/util/List;
    ...
    iget v0, p0, Lya/aa;->j:I

    const/4 v2, 0x0

    invoke-static {v0, v2}, Lya/ha;->t(II)Z
