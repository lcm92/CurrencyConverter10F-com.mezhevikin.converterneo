...
.field public static final i:Ls4/ja;

.field public static final j:Ls4/ja;
...
.method static synthetic constructor <clinit>()V
    ...
    sput-object v0, Ls4/y;->h:Li7/i;

    new-instance v0, Ls4/ja;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Ls4/ja;-><init>(Z)V

    sput-object v0, Ls4/y;->i:Ls4/ja;
    ...
    sput-object v0, Ls4/y;->j:Ls4/ja;

    return-void
.end method

.method public static final A(Ly8/d;)Ljava/lang/String;
    .locals 3
    ...
    :goto_0
    invoke-static {v1}, Lu8/l;->a(Ljava/lang/Object;)Ljava/lang/Throwable;
...
.method public static final B(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    instance-of v0, p0, Ls4/va;

    if-eqz v0, :cond_0

    move-object v0, p0

    check-cast v0, Ls4/va;
    ...
    iget-object v0, v0, Ls4/va;->a:Ls4/ua;
...
.method public static final C(Ly8/d;Ly8/i;Ljava/lang/Object;)Ls4/u0;
    .locals 2
    ...
    invoke-virtual {v1, p1, p2}, Ls4/u0;->r0(Ly8/i;Ljava/lang/Object;)V

    :cond_4
    return-object v1
.end method

.method public static final D(Ly8/i;Lh4/e;Ly8/d;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-interface {p0, v1, v2}, Ly8/i;->h(Ljava/lang/Object;Lh4/e;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p0}, Ly8/i;->f(Ly8/i;)Ly8/i;
    ...
    :cond_0
    invoke-static {v0, p0, v2}, Ls4/y;->j(Ly8/i;Ly8/i;Z)Ly8/i;

    move-result-object p0

    :goto_0
    invoke-static {p0}, Ls4/y;->i(Ly8/i;)V

    if-ne p0, v0, :cond_1

    new-instance v0, Lx4/q;

    invoke-direct {v0, p2, p0}, Lx4/q;-><init>(Ly8/d;Ly8/i;)V
    ...
    invoke-direct {v0, p2, p0}, Ls4/u0;-><init>(Ly8/d;Ly8/i;)V

    const/4 p0, 0x0

    iget-object p2, v0, Ls4/a;->i:Ly8/i;

    invoke-static {p2, p0}, Lx4/a;->m(Ly8/i;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, p0}, Lx4/a;->g(Ly8/i;Ljava/lang/Object;)V
    ...
    :cond_3
    sget-object p0, Ls4/da;->k:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public static final F(La4/c;)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v0}, Ls4/t;->z(Ly8/i;)Z
    ...
    iput v6, p0, Ls4/ea;->i:I

    invoke-virtual {v4, v0, p0}, Ls4/t;->y(Ly8/i;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v5, v7}, Ly8/a;-><init>(Ly8/h;)V

    invoke-interface {v0, v5}, Ly8/i;->f(Ly8/i;)Ly8/i;
    ...
    invoke-static {}, Ls4/p0;->a()Ls4/pa;

    move-result-object v0

    iget-object v4, v0, Ls4/pa;->k:Lv8/i;

    if-eqz v4, :cond_3

    invoke-virtual {v4}, Lv8/i;->isEmpty()Z
    ...
    invoke-virtual {v0, p0}, Ls4/pa;->D(Ls4/ea;)V
    ...
    :cond_6
    invoke-virtual {v0, v6}, Ls4/pa;->F(Z)V

    :try_start_0
    invoke-virtual {p0}, Ls4/ea;->run()V

    :cond_7
    invoke-virtual {v0}, Ls4/pa;->I()Z
    ...
    :goto_4
    invoke-virtual {v0, v6}, Ls4/pa;->C(Z)V
    ...
    :try_start_1
    invoke-virtual {p0, v4, v2}, Ls4/ea;->f(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public static final b(Ly8/i;)Lx4/d;
    .locals 2
    ...
    invoke-interface {p0, v1}, Ly8/i;->f(Ly8/i;)Ly8/i;

    move-result-object p0

    :goto_0
    invoke-direct {v0, p0}, Lx4/d;-><init>(Ly8/i;)V
...
.method public static synthetic e(Ls4/xa;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0}, Ls4/xa;->c(Ljava/util/concurrent/CancellationException;)V

    return-void
.end method

.method public static final f(Ls4/xa;La4/i;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-interface {p0, p1}, Ls4/xa;->A(La4/c;)Ljava/lang/Object;
...
.method public static final g(Lh4/e;Ly8/d;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lx4/q;-><init>(Ly8/d;Ly8/i;)V
...
.method public static final h(JLa4/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v2, p2}, Ls4/f;-><init>(ILy8/d;)V
    ...
    iget-object p2, v0, Ls4/f;->k:Ly8/i;

    invoke-static {p2}, Ls4/y;->k(Ly8/i;)Ls4/ca;

    move-result-object p2

    invoke-interface {p2, p0, p1, v0}, Ls4/ca;->b(JLs4/f;)V
...
.method public static final i(Ly8/i;)V
    .locals 1
    ...
    check-cast p0, Ls4/xa;

    if-eqz p0, :cond_1

    invoke-interface {p0}, Ls4/xa;->d()Z
    ...
    :cond_0
    invoke-interface {p0}, Ls4/xa;->i()Ljava/util/concurrent/CancellationException;
...
.method public static final j(Ly8/i;Ly8/i;Z)Ly8/i;
    .locals 4
    ...
    invoke-interface {p0, p2, v0}, Ly8/i;->h(Ljava/lang/Object;Lh4/e;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p2, v0}, Ly8/i;->h(Ljava/lang/Object;Lh4/e;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Ly8/i;->f(Ly8/i;)Ly8/i;
    ...
    invoke-interface {p0, v0, v1}, Ly8/i;->h(Ljava/lang/Object;Lh4/e;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p2}, Ly8/i;->h(Ljava/lang/Object;Lh4/e;)Ljava/lang/Object;
...
.method public static final k(Ly8/i;)Ls4/ca;
    .locals 1
    ...
    instance-of v0, p0, Ls4/ca;

    if-eqz v0, :cond_0

    check-cast p0, Ls4/ca;
    ...
    sget-object p0, Ls4/aa;->a:Ls4/ca;
...
.method public static final m(Ly8/i;)Ls4/xa;
    .locals 3
...
.method public static final n(Ly8/d;)Ls4/f;
    .locals 6
    ...
    invoke-direct {v0, v1, p0}, Ls4/f;-><init>(ILy8/d;)V
...
.method public static final o(Ly8/i;Ljava/lang/Throwable;)V
    .locals 3
    ...
    invoke-interface {v0, p0, p1}, Ls4/v;->r(Ly8/i;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    invoke-static {p0, p1}, Lx4/a;->d(Ly8/i;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, p1}, Lu8/a;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static synthetic p(Ls4/xa;ZLh4/c;I)Ls4/ga;
    .locals 2
    ...
    :cond_1
    invoke-interface {p0, p1, v1, p2}, Ls4/xa;->v(ZZLh4/c;)Ls4/ga;
...
.method public static final q(Ly8/i;)Z
    .locals 1
...
.method public static final t(Ls4/x;Ly8/i;ILh4/e;)Ls4/ba;
    .locals 2

    invoke-static {p0, p1}, Ls4/y;->v(Ls4/x;Ly8/i;)Ly8/i;
    ...
    invoke-direct {p1, p0, p3}, Ls4/h0;-><init>(Ly8/i;Lh4/e;)V
    ...
    invoke-direct {p1, p0, v0, v0, v1}, Ls4/ba;-><init>(Ly8/i;ZZI)V
...
.method public static synthetic u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;
    .locals 1
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Ls4/y;->t(Ls4/x;Ly8/i;ILh4/e;)Ls4/ba;
...
.method public static final v(Ls4/x;Ly8/i;)Ly8/i;
    .locals 1
    ...
    invoke-static {p0, p1, v0}, Ls4/y;->j(Ly8/i;Ly8/i;Z)Ly8/i;

    move-result-object p0

    sget-object p1, Ls4/fa;->a:Lz4/d;
...
.method public static final x(Ls4/f;Ly8/d;Z)V
    .locals 2
    ...
    invoke-static {v0, p1}, Lx4/a;->m(Ly8/i;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    sget-object v1, Lx4/a;->f:Li7/i;

    if-eq p1, v1, :cond_1

    invoke-static {p2, v0, p1}, Ls4/y;->C(Ly8/d;Ly8/i;Ljava/lang/Object;)Ls4/u0;
    ...
    :cond_2
    invoke-static {v0, p1}, Lx4/a;->g(Ly8/i;Ljava/lang/Object;)V
    ...
    :cond_5
    invoke-interface {p1, p0}, Ly8/d;->s(Ljava/lang/Object;)V
...
.method public static final y(Ly8/i;Lh4/e;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-static {v3, p0, v4}, Ls4/y;->j(Ly8/i;Ly8/i;Z)Ly8/i;

    move-result-object p0

    sget-object v3, Ls4/fa;->a:Lz4/d;
    ...
    invoke-interface {p0, v3}, Ly8/i;->f(Ly8/i;)Ly8/i;
    ...
    :cond_0
    instance-of v5, v2, Ls4/pa;

    if-eqz v5, :cond_1

    check-cast v2, Ls4/pa;
    ...
    invoke-direct {v1, p0, v0, v2}, Ls4/c;-><init>(Ly8/i;Ljava/lang/Thread;Ls4/pa;)V

    invoke-virtual {v1, v4, v1, p1}, Ls4/a;->p0(ILs4/a;Lh4/e;)V

    const/4 p0, 0x0

    iget-object p1, v1, Ls4/c;->k:Ls4/pa;

    if-eqz p1, :cond_3

    sget v0, Ls4/pa;->l:I

    invoke-virtual {p1, p0}, Ls4/pa;->F(Z)V
    ...
    invoke-virtual {p1, p0}, Ls4/pa;->C(Z)V
...
.method public static final z(Ls4/r0;Lh4/e;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Ls4/a;->i:Ly8/i;

    invoke-interface {v0, v1, v2, p0, v3}, Ls4/ca;->g(JLs4/r0;Ly8/i;)Ls4/ga;

    move-result-object v0

    new-instance v1, Ls4/ia;

    const/4 v2, 0x0

    invoke-direct {v1, v2, v0}, Ls4/ia;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, v1}, Ls4/g0;->q(Lh4/c;)Ls4/ga;
