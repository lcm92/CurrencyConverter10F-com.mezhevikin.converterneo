...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ls4/O1;->m:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Ls4/O1;->n:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Ls4/O1;->o:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Ls4/O1;->_isCompleted:I
...
.method public final H()J
    ...
    :cond_0
    sget-object v0, Ls4/O1;->n:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :try_start_0
    iget-object v7, v0, Lx4/v;->a:[Ls4/M1;
    ...
    invoke-virtual {p0, v7}, Ls4/O1;->L(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, v4}, Lx4/v;->b(I)Ls4/M1;
    ...
    :cond_7
    :goto_5
    sget-object v0, Ls4/O1;->m:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public K(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Ls4/O1;->L(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Ls4/P1;->E()Ljava/lang/Thread;
...
.method public final N(JLs4/M1;)V
    .locals 6

    sget-object v0, Ls4/O1;->o:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :goto_0
    sget-object v3, Ls4/O1;->n:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    new-instance v5, Ls4/N1;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-wide p1, v5, Ls4/N1;->c:J
    ...
    :cond_4
    invoke-virtual {p3, p1, p2, v0, p0}, Ls4/M1;->b(JLs4/N1;Ls4/O1;)I
    ...
    :cond_6
    invoke-virtual {p0, p1, p2, p3}, Ls4/P1;->J(JLs4/M1;)V
    ...
    :try_start_0
    iget-object p2, p1, Lx4/v;->a:[Ls4/M1;
...
.method public final b(JLs4/f;)V
    ...
    new-instance v2, Ls4/K1;

    add-long/2addr v0, p1

    invoke-direct {v2, p0, v0, v1, p3}, Ls4/K1;-><init>(Ls4/O1;JLs4/f;)V

    invoke-virtual {p0, p1, p2, v2}, Ls4/O1;->N(JLs4/M1;)V

    new-instance p1, Ls4/H1;

    const/4 p2, 0x0

    invoke-direct {p1, p2, v2}, Ls4/H1;-><init>(ILjava/lang/Object;)V
...
.method public g(JLs4/r0;Ly9/i;)Ls4/G1;
    .locals 1

    sget-object v0, Ls4/A1;->a:Ls4/C1;
...
.method public shutdown()V
    ...
    :cond_8
    invoke-virtual {p0, v2, v3, v4}, Ls4/P1;->J(JLs4/M1;)V
...
.method public final u(Ly9/i;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Ls4/O1;->K(Ljava/lang/Runnable;)V
