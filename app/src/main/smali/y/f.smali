...
.field public b:Ls4/ba;

.field public c:Ly/y;

.field public d:Lv4/ea;
...
.method public final a(Lf5/w;Lf5/m;Loa/h;Lw/r;)V
    ...
    invoke-virtual {p0, v7}, Ly/f;->j(Lo5/g;)V
...
.method public final c(Lf5/w;Lca/q;Lz0/ca;Lj3/fa;Lxa/d;Lxa/d;)V
    ...
    :try_start_0
    iput-object p1, p4, Ly/v;->j:Lf5/w;

    iput-object p2, p4, Ly/v;->l:Lca/q;

    iput-object p3, p4, Ly/v;->k:Lz0/ca;

    iput-object p5, p4, Ly/v;->m:Lxa/d;

    iput-object p6, p4, Ly/v;->n:Lxa/d;
...
.method public final e()V
    ...
    iget-object v0, p0, Ly/f;->b:Ls4/ba;
    ...
    :cond_0
    iput-object v1, p0, Ly/f;->b:Ls4/ba;
    ...
    :try_start_0
    invoke-virtual {v0}, Lv4/ea;->o()J

    move-result-wide v1

    iget v3, v0, Lv4/ea;->q:I

    int-to-long v3, v3

    add-long v2, v1, v3

    iget-wide v4, v0, Lv4/ea;->p:J

    invoke-virtual {v0}, Lv4/ea;->o()J

    move-result-wide v6

    iget v1, v0, Lv4/ea;->q:I
    ...
    invoke-virtual/range {v1 .. v9}, Lv4/ea;->u(JJJJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final f(Lxa/d;)V
    ...
    iget v2, p1, Lxa/d;->a:F

    invoke-static {v2}, Lk4/a;->Z(F)I

    move-result v2

    iget v3, p1, Lxa/d;->b:F

    invoke-static {v3}, Lk4/a;->Z(F)I

    move-result v3

    iget v4, p1, Lxa/d;->c:F
...
.method public final g(Lf5/w;Lf5/w;)V
    ...
    iget-object v1, v0, Ly/y;->h:Lf5/w;

    iget-wide v1, v1, Lf5/w;->b:J

    iget-wide v3, p2, Lf5/w;->b:J
    ...
    iget-object v3, p2, Lf5/w;->c:Lz0/ea;
    ...
    :goto_1
    iput-object p2, v0, Ly/y;->h:Lf5/w;
    ...
    :cond_2
    iput-object p2, v5, Ly/aa;->g:Lf5/w;
    ...
    :try_start_0
    iput-object v5, v3, Ly/v;->j:Lf5/w;

    iput-object v5, v3, Ly/v;->l:Lca/q;

    iput-object v5, v3, Ly/v;->k:Lz0/ca;

    iput-object v5, v3, Ly/v;->m:Lxa/d;

    iput-object v5, v3, Ly/v;->n:Lxa/d;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object p2, v0, Ly/y;->h:Lf5/w;

    iget-object p2, p2, Lf5/w;->c:Lz0/ea;

    if-eqz p2, :cond_4

    iget-wide v1, p2, Lz0/ea;->a:J
    ...
    iget-object v1, p1, Lf5/w;->a:Lz0/f;

    iget-object v1, v1, Lz0/f;->g:Ljava/lang/String;

    iget-object v3, p2, Lf5/w;->a:Lz0/f;
    ...
    iget-wide v5, p1, Lf5/w;->b:J

    iget-wide v7, p2, Lf5/w;->b:J

    invoke-static {v5, v6, v7, v8}, Lz0/ea;->a(JJ)Z
    ...
    :cond_9
    iput-object v1, p2, Ly/aa;->g:Lf5/w;

    iget-boolean v5, p2, Ly/aa;->i:Z

    if-eqz v5, :cond_a

    iget p2, p2, Ly/aa;->h:I

    invoke-static {v1}, Lp4/h;->c(Lf5/w;)Landroid/view/inputmethod/ExtractedText;
    ...
    :cond_a
    iget-object p2, v1, Lf5/w;->c:Lz0/ea;

    if-eqz p2, :cond_b

    iget-wide v5, p2, Lz0/ea;->a:J

    invoke-static {v5, v6}, Lz0/ea;->e(J)I
    ...
    invoke-static {v5, v6}, Lz0/ea;->d(J)I
...
.method public final h()V
    ...
    invoke-virtual {p0, v0}, Ly/f;->j(Lo5/g;)V
...
.method public final i()Lv4/y;
    ...
    iget-object v0, p0, Ly/f;->d:Lv4/ea;
    ...
    iput-object v0, p0, Ly/f;->d:Lv4/ea;

    return-object v0
.end method

.method public final j(Lo5/g;)V
    .locals 4
    ...
    invoke-direct {v1, p1, p0, v0, v2}, Ly/e;-><init>(Lo5/g;Ly/f;Ly/u;Ly8/d;)V
    ...
    :cond_1
    invoke-virtual {v0}, Lra/p;->m0()Ls4/x;

    move-result-object p1

    new-instance v3, Ly/t;

    invoke-direct {v3, v0, v1, v2}, Ly/t;-><init>(Ly/u;Ly/e;Ly8/d;)V

    const/4 v0, 0x1

    const/4 v1, 0x4

    invoke-static {p1, v2, v1, v3, v0}, Ls4/y;->u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;

    move-result-object v2

    :goto_0
    iput-object v2, p0, Ly/f;->b:Ls4/ba;
