...
.field public e:Lw/qa;

.field public f:Laa/b0;

.field public g:Lr0/oa0;

.field public h:Lf5/w;

.field public i:Lf5/m;
...
.method public constructor <init>(Landroid/view/View;Ly/c;Ly/s;)V
    ...
    invoke-direct {p1, v2, v0, v1, v3}, Lf5/w;-><init>(IJLjava/lang/String;)V

    iput-object p1, p0, Ly/y;->h:Lf5/w;

    sget-object p1, Lf5/m;->g:Lf5/m;

    iput-object p1, p0, Ly/y;->i:Lf5/m;
...
# virtual methods
.method public final a(Landroid/view/inputmethod/EditorInfo;)Ly/aa;
    .locals 16
    ...
    iget-object v3, v0, Ly/y;->h:Lf5/w;

    iget-object v4, v3, Lf5/w;->a:Lz0/f;

    iget-object v4, v4, Lz0/f;->g:Ljava/lang/String;

    iget-object v5, v0, Ly/y;->i:Lf5/m;

    iget v6, v5, Lf5/m;->e:I

    invoke-static {v6, v2}, Lf5/l;->a(II)Z
    ...
    :cond_1
    invoke-static {v6, v10}, Lf5/l;->a(II)Z
    ...
    :cond_2
    invoke-static {v6, v14}, Lf5/l;->a(II)Z
    ...
    :cond_3
    invoke-static {v6, v12}, Lf5/l;->a(II)Z
    ...
    :cond_4
    invoke-static {v6, v9}, Lf5/l;->a(II)Z
    ...
    :cond_5
    invoke-static {v6, v13}, Lf5/l;->a(II)Z
    ...
    :cond_6
    invoke-static {v6, v8}, Lf5/l;->a(II)Z
    ...
    :cond_7
    invoke-static {v6, v11}, Lf5/l;->a(II)Z
    ...
    iget-object v7, v5, Lf5/m;->f:Lg5/b;

    invoke-virtual {v6, v1, v7}, Ly/z;->a(Landroid/view/inputmethod/EditorInfo;Lg5/b;)V

    iget v6, v5, Lf5/m;->d:I

    invoke-static {v6, v2}, Lf5/o;->a(II)Z
    ...
    :cond_8
    invoke-static {v6, v14}, Lf5/o;->a(II)Z
    ...
    :cond_9
    invoke-static {v6, v13}, Lf5/o;->a(II)Z
    ...
    :cond_a
    invoke-static {v6, v8}, Lf5/o;->a(II)Z
    ...
    :cond_b
    invoke-static {v6, v9}, Lf5/o;->a(II)Z
    ...
    :cond_c
    invoke-static {v6, v12}, Lf5/o;->a(II)Z
    ...
    :cond_d
    invoke-static {v6, v11}, Lf5/o;->a(II)Z
    ...
    :cond_e
    invoke-static {v6, v10}, Lf5/o;->a(II)Z
    ...
    invoke-static {v6, v7}, Lf5/o;->a(II)Z
    ...
    iget v7, v5, Lf5/m;->e:I

    invoke-static {v7, v2}, Lf5/l;->a(II)Z
    ...
    iget v7, v5, Lf5/m;->b:I

    invoke-static {v7, v2}, Lf5/n;->a(II)Z
    ...
    :cond_11
    invoke-static {v7, v14}, Lf5/n;->a(II)Z
    ...
    :cond_12
    invoke-static {v7, v13}, Lf5/n;->a(II)Z
    ...
    :goto_6
    iget-object v4, v0, Ly/y;->h:Lf5/w;

    iget-object v1, v0, Ly/y;->i:Lf5/m;

    iget-boolean v6, v1, Lf5/m;->c:Z
    ...
    iget-object v7, v0, Ly/y;->e:Lw/qa;

    iget-object v8, v0, Ly/y;->f:Laa/b0;

    iget-object v9, v0, Ly/y;->g:Lr0/oa0;

    new-instance v1, Ly/aa;

    move-object v3, v1

    invoke-direct/range {v3 .. v9}, Ly/aa;-><init>(Lf5/w;Lk3/b;ZLw/qa;Laa/b0;Lr0/oa0;)V
