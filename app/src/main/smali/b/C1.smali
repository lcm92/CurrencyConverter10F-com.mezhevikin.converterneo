...
.method public constructor <init>(Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Lb/C1;->a:Ljava/lang/Runnable;

    new-instance p1, Lv9/i;

    invoke-direct {p1}, Lv9/i;-><init>()V

    iput-object p1, p0, Lb/C1;->b:Lv9/i;
    ...
    invoke-direct {v0, p0, v1}, Lb/v;-><init>(Lb/C1;I)V

    new-instance v1, Lb/v;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lb/v;-><init>(Lb/C1;I)V

    new-instance v2, Lb/w;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lb/w;-><init>(Lb/C1;I)V

    new-instance v3, Lb/w;

    const/4 v4, 0x1

    invoke-direct {v3, p0, v4}, Lb/w;-><init>(Lb/C1;I)V
    ...
    invoke-direct {v0, p0, v1}, Lb/w;-><init>(Lb/C1;I)V
    ...
    :goto_0
    iput-object p1, p0, Lb/C1;->d:Landroid/window/OnBackInvokedCallback;
...
.method public final a(Landroidx/lifecycle/t;Lb/u;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lb/A1;-><init>(Lb/C1;Landroidx/lifecycle/v;Lb/u;)V

    iget-object p1, p2, Lb/u;->b:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-virtual {p1, v0}, Ljava/util/concurrent/CopyOnWriteArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0}, Lb/C1;->e()V

    new-instance p1, Lw5/e;

    const-class v4, Lb/C1;
...
.method public final b()V
    ...
    iget-object v0, p0, Lb/C1;->c:Lb/u;

    const/4 v1, 0x0

    if-nez v0, :cond_2

    iget-object v0, p0, Lb/C1;->b:Lv9/i;
    ...
    :cond_2
    iput-object v1, p0, Lb/C1;->c:Lb/u;
...
.method public final c()V
    ...
    :cond_3
    iget-object v0, p0, Lb/C1;->a:Ljava/lang/Runnable;
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lb/C1;->e:Landroid/window/OnBackInvokedDispatcher;

    iget-object v1, p0, Lb/C1;->d:Landroid/window/OnBackInvokedCallback;
...
.method public final e()V
    ...
    iget-boolean v0, p0, Lb/C1;->g:Z

    const/4 v1, 0x0

    iget-object v2, p0, Lb/C1;->b:Lv9/i;
    ...
    invoke-virtual {p0, v1}, Lb/C1;->d(Z)V
