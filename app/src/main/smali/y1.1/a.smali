...
.method public static b(Landroid/content/Context;Lw1/k;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->k()LE0/l;

    move-result-object v0

    invoke-virtual {v0, p2}, LE0/l;->p(Ljava/lang/String;)LE1/d;
    ...
    invoke-direct {v8, v4, v9, v10}, LE1/c;-><init>(Ljava/lang/String;J)V

    invoke-virtual {v7, v8}, Ly/s;->s(LE1/c;)V
    ...
    invoke-direct {p1, p2, v5}, LE1/d;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v0, p1}, LE0/l;->s(LE1/d;)V
