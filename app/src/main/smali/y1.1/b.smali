...
.method public final d(ILandroid/content/Intent;Ly1/g;)V
    ...
    invoke-virtual {p1}, LE1/j;->d()Ljava/util/ArrayList;
    ...
    iget-object v6, v6, LE1/i;->j:Lv1/c;
    ...
    iget-object v0, p2, Ly1/d;->c:LA1/c;

    invoke-virtual {v0, p1}, LA1/c;->b(Ljava/util/Collection;)V
    ...
    iget-object v6, v5, LE1/i;->a:Ljava/lang/String;

    invoke-virtual {v5}, LE1/i;->a()J
    ...
    invoke-virtual {v5}, LE1/i;->b()Z

    move-result v8

    if-eqz v8, :cond_4

    invoke-virtual {v0, v6}, LA1/c;->a(Ljava/lang/String;)Z
    ...
    iget-object v1, v1, LE1/i;->a:Ljava/lang/String;
    ...
    invoke-direct {v1, v4, v3, p3}, LD1/d;-><init>(ILandroid/content/Intent;Ly1/g;)V
    ...
    :try_start_0
    invoke-virtual {v3}, Landroidx/work/impl/WorkDatabase;->n()LE1/j;

    move-result-object v4

    invoke-virtual {v4, p2}, LE1/j;->h(Ljava/lang/String;)LE1/i;
    ...
    invoke-direct {v0, p1, p2, p3}, LD1/d;-><init>(ILandroid/content/Intent;Ly1/g;)V
    ...
    invoke-virtual {p2}, Landroidx/work/impl/WorkDatabase;->k()LE0/l;

    move-result-object p2

    invoke-virtual {p2, p1}, LE0/l;->p(Ljava/lang/String;)LE1/d;
    ...
    invoke-virtual {p2, p1}, LE0/l;->z(Ljava/lang/String;)V
