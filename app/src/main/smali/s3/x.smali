...
.field public final j:LR3/f;

.field public final k:Lu4/d;

.field public final l:LB/F;


# direct methods
.method public constructor <init>(Lio/ktor/utils/io/L;LY3/i;ZLR3/f;)V
    .locals 1
    ...
    iput-object p1, p0, LS3/x;->g:Lio/ktor/utils/io/L;

    iput-object p2, p0, LS3/x;->h:LY3/i;

    iput-boolean p3, p0, LS3/x;->i:Z

    iput-object p4, p0, LS3/x;->j:LR3/f;
    ...
    iput-object p1, p0, LS3/x;->k:Lu4/d;

    new-instance p1, LB/F;

    const/4 p2, 0x2

    invoke-direct {p1, p2}, LB/F;-><init>(I)V

    iput-object p1, p0, LS3/x;->l:LB/F;
    ...
    invoke-direct {p2, p0, p3}, LS3/w;-><init>(LS3/x;LY3/d;)V
...
.method public static final a(LS3/x;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    .locals 11
    ...
    invoke-direct {v0, p0, p2}, LS3/v;-><init>(LS3/x;La4/c;)V

    :goto_0
    iget-object p2, v0, LS3/v;->m:Ljava/lang/Object;

    sget-object v1, LZ3/a;->g:LZ3/a;

    iget v2, v0, LS3/v;->o:I
    ...
    iget-object p0, v0, LS3/v;->l:Lu4/c;

    iget-object p1, v0, LS3/v;->k:Ljava/nio/ByteBuffer;

    iget-object v2, v0, LS3/v;->j:LS3/x;
    ...
    :try_start_2
    iget-object p2, p0, LS3/x;->k:Lu4/d;
    ...
    :cond_5
    iput-object p0, v0, LS3/v;->j:LS3/x;

    iput-object p1, v0, LS3/v;->k:Ljava/nio/ByteBuffer;

    iput-object v2, v0, LS3/v;->l:Lu4/c;

    iput v7, v0, LS3/v;->o:I
    ...
    instance-of v9, p2, LS3/h;

    if-eqz v9, :cond_7

    check-cast p2, LS3/h;

    iput-object v2, v0, LS3/v;->j:LS3/x;

    iput-object p1, v0, LS3/v;->k:Ljava/nio/ByteBuffer;

    iput-object p0, v0, LS3/v;->l:Lu4/c;

    iput v5, v0, LS3/v;->o:I

    invoke-virtual {v2, p2, p1, v0}, LS3/x;->c(LS3/h;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    ...
    :cond_8
    :goto_3
    iget-object p0, v2, LS3/x;->k:Lu4/d;
    ...
    :goto_4
    iget-object p0, v2, LS3/x;->g:Lio/ktor/utils/io/L;
    ...
    :goto_5
    :try_start_6
    iget-object p1, v2, LS3/x;->k:Lu4/d;
    ...
    :cond_b
    instance-of p2, p1, LS3/d;

    if-nez p2, :cond_9

    instance-of p2, p1, LS3/e;
    ...
    iget-object p1, v2, LS3/x;->g:Lio/ktor/utils/io/L;
...
.method public final b()LY3/i;
    ...
    iget-object v0, p0, LS3/x;->h:LY3/i;

    return-object v0
.end method

.method public final c(LS3/h;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    .locals 18
    ...
    invoke-direct {v3, v0, v2}, LS3/u;-><init>(LS3/x;La4/c;)V

    :goto_0
    iget-object v2, v3, LS3/u;->n:Ljava/lang/Object;

    sget-object v4, LZ3/a;->g:LZ3/a;

    iget v5, v3, LS3/u;->p:I
    ...
    iget v1, v3, LS3/u;->m:I

    iget-object v5, v3, LS3/u;->l:Li4/s;

    iget-object v7, v3, LS3/u;->k:Ljava/nio/ByteBuffer;

    iget-object v8, v3, LS3/u;->j:LS3/x;
    ...
    iget-object v5, v0, LS3/x;->l:LB/F;
    ...
    iget-object v5, v5, LB/F;->b:Ljava/lang/Object;
    ...
    iget-object v10, v7, LS3/x;->k:Lu4/d;

    iget-object v11, v7, LS3/x;->l:LB/F;

    if-nez v8, :cond_7

    if-nez v2, :cond_7

    iget-object v8, v11, LB/F;->b:Ljava/lang/Object;
    ...
    :cond_4
    instance-of v9, v8, LS3/d;

    iget-object v10, v11, LB/F;->b:Ljava/lang/Object;
    ...
    iget-object v8, v11, LB/F;->c:Ljava/lang/Object;
    ...
    :cond_b
    iget-object v1, v7, LS3/x;->g:Lio/ktor/utils/io/L;
    ...
    :cond_e
    :goto_7
    iget-boolean v8, v7, LS3/x;->i:Z

    iput-boolean v8, v11, LB/F;->a:Z
    ...
    iput-object v9, v11, LB/F;->c:Ljava/lang/Object;
    ...
    iput-object v10, v11, LB/F;->d:Ljava/lang/Object;

    goto :goto_a

    :cond_11
    iput-object v9, v11, LB/F;->d:Ljava/lang/Object;

    :goto_a
    iget-object v10, v13, LS3/h;->g:Ljava/nio/ByteBuffer;
    ...
    :goto_d
    iget-object v15, v11, LB/F;->e:Ljava/lang/Object;

    check-cast v15, LS3/l;

    iget-object v6, v13, LS3/h;->b:LS3/l;

    iget v9, v6, LS3/l;->h:I

    iget-boolean v0, v13, LS3/h;->a:Z

    if-nez v15, :cond_19

    if-nez v0, :cond_18

    iput-object v6, v11, LB/F;->e:Ljava/lang/Object;
    ...
    iput-object v15, v11, LB/F;->e:Ljava/lang/Object;
    ...
    :goto_14
    iget-object v0, v11, LB/F;->d:Ljava/lang/Object;
    ...
    invoke-static {v6, v0}, LH2/b;->a0(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V

    move-object v10, v6

    :cond_24
    iput-object v10, v11, LB/F;->c:Ljava/lang/Object;
    ...
    :cond_27
    iput-object v8, v5, LS3/u;->j:LS3/x;

    iput-object v1, v5, LS3/u;->k:Ljava/nio/ByteBuffer;

    iput-object v3, v5, LS3/u;->l:Li4/s;

    iput v2, v5, LS3/u;->m:I

    const/4 v0, 0x1

    iput v0, v5, LS3/u;->p:I

    iget-object v6, v8, LS3/x;->g:Lio/ktor/utils/io/L;
    ...
    :cond_28
    :goto_16
    iget-object v6, v8, LS3/x;->l:LB/F;

    iget-object v7, v6, LB/F;->b:Ljava/lang/Object;
    ...
    iget-object v6, v6, LB/F;->c:Ljava/lang/Object;
