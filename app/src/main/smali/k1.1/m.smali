...
# direct methods
.method public synthetic constructor <init>(LP/s;Lj1/h;Z)V
    .locals 0
    ...
    iput-object p1, p0, Lk1/m;->h:LP/s;
...
.method public final c(Landroidx/lifecycle/t;Landroidx/lifecycle/n;)V
    ...
    iget-object v1, p0, Lk1/m;->h:LP/s;

    if-eqz v0, :cond_0

    invoke-virtual {v1, p1}, LP/s;->contains(Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {v1, p1}, LP/s;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, p1}, LP/s;->remove(Ljava/lang/Object;)Z
