...
.method public static final a(Lr0/a;LF/r;LN/a;)Lr0/l1;
    .locals 6
    ...
    invoke-static {v2}, Ls4/y;->b(LY3/i;)Lx4/d;

    move-result-object v2

    new-instance v4, Lr0/n0;

    invoke-direct {v4, v0, v3}, Lr0/n0;-><init>(Lu4/d;LY3/d;)V

    const/4 v5, 0x3

    invoke-static {v2, v3, v1, v4, v5}, Ls4/y;->u(Ls4/x;LY3/i;ILh4/e;I)Ls4/B;
    ...
    :try_start_0
    sget-object v4, LP/p;->h:Ljava/lang/Object;

    invoke-static {v4, v2}, LV3/k;->w0(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v2

    sput-object v2, LP/p;->h:Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {p1}, LF/r;->h()LY3/i;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lr0/u;-><init>(Landroid/content/Context;LY3/i;)V
    ...
    invoke-direct {v1, p1, p0}, LF/t;-><init>(LF/r;Lo2/b;)V
    ...
    invoke-direct {v3, v0, v1}, Lr0/l1;-><init>(Lr0/u;LF/t;)V
    ...
    :cond_5
    invoke-virtual {v3, p2}, Lr0/l1;->e(LN/a;)V

    invoke-virtual {v0}, Lr0/u;->getCoroutineContext()LY3/i;
    ...
    invoke-virtual {v0, p0}, Lr0/u;->setCoroutineContext(LY3/i;)V
