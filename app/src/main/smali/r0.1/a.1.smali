...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p3}, LA/s;-><init>(I)V
...
.method private final setParentContext(LF/r;)V
    ...
    iget-object v0, p0, Lr0/a;->j:LF/r;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lr0/a;->j:LF/r;
...
# virtual methods
.method public abstract a(ILF/p;)V
.end method
...
.method public final c()V
    ...
    invoke-virtual {p0}, Lr0/a;->f()LF/r;
    ...
    invoke-direct {v3, v4, p0}, LC/v;-><init>(ILjava/lang/Object;)V

    new-instance v4, LN/a;

    const v5, -0x271bffc0

    invoke-direct {v4, v5, v3, v1}, LN/a;-><init>(ILjava/lang/Object;Z)V

    invoke-static {p0, v2, v4}, Lr0/n1;->a(Lr0/a;LF/r;LN/a;)Lr0/l1;
...
.method public final f()LF/r;
    ...
    iget-object v1, p0, Lr0/a;->j:LF/r;

    if-nez v1, :cond_15

    invoke-static {p0}, Lr0/h1;->b(Landroid/view/View;)LF/r;
    ...
    invoke-static {v1}, Lr0/h1;->b(Landroid/view/View;)LF/r;
    ...
    iget-object v3, v3, LF/z0;->r:Lv4/P;
    ...
    :cond_9
    :goto_7
    invoke-static {v9}, Lr0/h1;->b(Landroid/view/View;)LF/r;
    ...
    :goto_8
    invoke-interface {v3, v1}, LY3/i;->f(LY3/i;)LY3/i;

    move-result-object v3

    sget-object v4, LF/W;->h:LF/W;
    ...
    invoke-direct {v5, v4}, LF/l0;-><init>(LF/X;)V

    iget-object v4, v5, LF/l0;->i:Ljava/lang/Object;

    check-cast v4, LF/S;

    iget-object v6, v4, LF/S;->c:Ljava/lang/Object;

    monitor-enter v6

    :try_start_0
    iput-boolean v10, v4, LF/S;->a:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v1, v4}, LY3/i;->f(LY3/i;)LY3/i;

    move-result-object v1

    new-instance v11, LF/z0;

    invoke-direct {v11, v1}, LF/z0;-><init>(LY3/i;)V

    iget-object v3, v11, LF/z0;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean v4, v11, LF/z0;->q:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    monitor-exit v3

    invoke-static {v1}, Ls4/y;->b(LY3/i;)Lx4/d;
    ...
    invoke-direct {v3, v9, v11}, Lr0/Z0;-><init>(Landroid/view/View;LF/z0;)V
    ...
    invoke-direct/range {v3 .. v8}, Lr0/e1;-><init>(Lx4/d;LF/l0;LF/z0;Li4/s;Landroid/view/View;)V
    ...
    invoke-direct {v4, v11, v9, v2}, Lr0/X0;-><init>(LF/z0;Landroid/view/View;LY3/d;)V

    invoke-static {v1, v3, v10, v4, v0}, Ls4/y;->u(Ls4/x;LY3/i;ILh4/e;I)Ls4/B;
    ...
    :goto_b
    iget-object v0, v1, LF/z0;->r:Lv4/P;
...
.method public final setParentCompositionContext(LF/r;)V
    ...
    invoke-direct {p0, p1}, Lr0/a;->setParentContext(LF/r;)V
