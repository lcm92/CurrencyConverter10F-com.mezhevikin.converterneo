...
.field public static final b:Ldef/l2/EL2;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Ldef/l2/FL2;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    const v0, 0xbdfcb8

    sput v0, Ldef/l2/EL2;->a:I

    new-instance v0, Ldef/l2/EL2;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Ldef/l2/EL2;->b:Ldef/l2/EL2;
...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, Ldef/p4/HP4;->d(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, Ldef/t2/BT2;->a(Landroid/content/Context;)Ldef/e5/BE5;
    ...
    iget-object p3, p3, Ldef/e5/BE5;->g:Landroid/content/Context;
...
.method public b(Landroid/content/Context;I)I
    ...
    sget-object v2, Ldef/l2/FL2;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v2, Ldef/o2/PO2;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    sget-boolean v3, Ldef/o2/PO2;->b:Z
    ...
    :cond_1
    sput-boolean v0, Ldef/o2/PO2;->b:Z
    ...
    :try_start_2
    iget-object v4, v4, Ldef/e5/BE5;->g:Landroid/content/Context;
    ...
    :cond_5
    :goto_4
    invoke-static {p1}, Ldef/p4/HP4;->d(Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_9

    sget-object v2, Ldef/p4/HP4;->c:Ljava/lang/Boolean;
    ...
    sput-object v2, Ldef/p4/HP4;->c:Ljava/lang/Boolean;
    ...
    const-class v8, Ldef/l2/GL2;

    monitor-enter v8

    :try_start_9
    sget-object v9, Ldef/l2/GL2;->h:Ldef/l2/GL2;

    if-nez v9, :cond_c

    sget-object v9, Ldef/l2/ML2;->a:Ldef/l2/IL2;

    const-class v9, Ldef/l2/ML2;
    ...
    :try_start_a
    sget-object v10, Ldef/l2/ML2;->c:Landroid/content/Context;
    ...
    sput-object v10, Ldef/l2/ML2;->c:Landroid/content/Context;
    :try_end_a
    ...
    :goto_8
    new-instance v9, Ldef/l2/GL2;

    invoke-direct {v9, v1}, Ldef/l2/GL2;-><init>(I)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    sput-object v9, Ldef/l2/GL2;->h:Ldef/l2/GL2;
    :try_end_d
    ...
    invoke-static {v7}, Ldef/l2/GL2;->p(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v6}, Ldef/o2/PO2;->c(Ljava/lang/Object;)V

    invoke-static {v6}, Ldef/l2/GL2;->p(Landroid/content/pm/PackageInfo;)Z
