.class public abstract Ldef/w5/BW5;
...
.field public static final b:Ldef/a5/UA5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldef/w5/BW5;->a:Ldef/i/PI;
    ...
    sput-object v0, Ldef/w5/BW5;->b:Ldef/a5/UA5;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)Ldef/j6/SJ6;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Ldef/w5/BW5;->b(Landroid/content/pm/PackageManager;Ldef/w5/CW5;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;

    move-result-object v3

    if-nez v3, :cond_0

    new-instance p0, Ldef/j6/SJ6;

    invoke-direct {p0}, Ldef/j6/SJ6;-><init>()V
    :try_end_0
    ...
    invoke-static {p0, v2, v3}, Ldef/w5/BW5;->c(Landroid/content/Context;Ldef/w5/CW5;Ljava/lang/String;)[Ldef/w5/GW5;
    ...
    invoke-direct {p0, v0}, Ldef/j6/SJ6;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Ldef/w5/CW5;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9

    sget-object v0, Ldef/w5/BW5;->a:Ldef/i/PI;
    ...
    invoke-static {v3}, Ldef/p3/EP3;->b(Ljava/lang/String;)V

    :try_start_0
    iget-object v3, p1, Ldef/w5/CW5;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v4, p1, Ldef/w5/CW5;->a:Ljava/lang/String;

    iget-object p1, p1, Ldef/w5/CW5;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v5}, Ldef/s5/BS5;->e(Landroid/content/res/Resources;I)Ljava/util/List;

    move-result-object v3

    :goto_0
    new-instance p2, Ldef/w5/AW5;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object v4, p2, Ldef/w5/AW5;->a:Ljava/lang/String;

    iput-object p1, p2, Ldef/w5/AW5;->b:Ljava/lang/String;

    iput-object v3, p2, Ldef/w5/AW5;->c:Ljava/util/List;

    invoke-virtual {v0, p2}, Ldef/i/PI;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    sget-object p0, Ldef/w5/BW5;->b:Ldef/a5/UA5;
    ...
    :cond_5
    invoke-virtual {v0, p2, v6}, Ldef/i/PI;->b(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_3
...
.method public static c(Landroid/content/Context;Ldef/w5/CW5;Ljava/lang/String;)[Ldef/w5/GW5;
    .locals 20
    ...
    iget-object v0, v0, Ldef/w5/CW5;->c:Ljava/lang/String;
    ...
    :goto_8
    new-instance v10, Ldef/w5/GW5;

    move-object v14, v10

    invoke-direct/range {v14 .. v19}, Ldef/w5/GW5;-><init>(Landroid/net/Uri;IIZI)V
