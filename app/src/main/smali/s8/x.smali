...
.field public final l:Lba/fa;


# direct methods
.method public constructor <init>(Lio/ktor/utils/io/L;Ly8/i;ZLr8/f;)V
    .locals 1
    ...
    iput-object p1, p0, Ls8/x;->g:Lio/ktor/utils/io/L;

    iput-object p2, p0, Ls8/x;->h:Ly8/i;

    iput-boolean p3, p0, Ls8/x;->i:Z

    iput-object p4, p0, Ls8/x;->j:Lr8/f;
    ...
    iput-object p1, p0, Ls8/x;->k:Lu4/d;

    new-instance p1, Lba/fa;

    const/4 p2, 0x2

    invoke-direct {p1, p2}, Lba/fa;-><init>(I)V

    iput-object p1, p0, Ls8/x;->l:Lba/fa;
    ...
    invoke-direct {p2, p0, p3}, Ls8/w;-><init>(Ls8/x;Ly8/d;)V
...
.method public static final a(Ls8/x;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    .locals 11

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v0, p2, Ls8/v;
    ...
    invoke-direct {v0, p0, p2}, Ls8/v;-><init>(Ls8/x;La4/c;)V

    :goto_0
    iget-object p2, v0, Ls8/v;->m:Ljava/lang/Object;

    sget-object v1, Lz8/a;->g:Lz8/a;

    iget v2, v0, Ls8/v;->o:I
    ...
    iget-object p0, v0, Ls8/v;->l:Lu4/c;

    iget-object p1, v0, Ls8/v;->k:Ljava/nio/ByteBuffer;

    iget-object v2, v0, Ls8/v;->j:Ls8/x;
    ...
    :try_start_2
    iget-object p2, p0, Ls8/x;->k:Lu4/d;
    ...
    :cond_5
    iput-object p0, v0, Ls8/v;->j:Ls8/x;

    iput-object p1, v0, Ls8/v;->k:Ljava/nio/ByteBuffer;

    iput-object v2, v0, Ls8/v;->l:Lu4/c;

    iput v7, v0, Ls8/v;->o:I
    ...
    instance-of v9, p2, Ls8/h;

    if-eqz v9, :cond_7

    check-cast p2, Ls8/h;

    iput-object v2, v0, Ls8/v;->j:Ls8/x;

    iput-object p1, v0, Ls8/v;->k:Ljava/nio/ByteBuffer;

    iput-object p0, v0, Ls8/v;->l:Lu4/c;

    iput v5, v0, Ls8/v;->o:I

    invoke-virtual {v2, p2, p1, v0}, Ls8/x;->c(Ls8/h;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    ...
    :cond_8
    :goto_3
    iget-object p0, v2, Ls8/x;->k:Lu4/d;
    ...
    :goto_4
    iget-object p0, v2, Ls8/x;->g:Lio/ktor/utils/io/L;
    ...
    :goto_5
    :try_start_6
    iget-object p1, v2, Ls8/x;->k:Lu4/d;
    ...
    iget-object p1, v2, Ls8/x;->g:Lio/ktor/utils/io/L;
...
.method public final b()Ly8/i;
    ...
    iget-object v0, p0, Ls8/x;->h:Ly8/i;

    return-object v0
.end method

.method public final c(Ls8/h;Ljava/nio/ByteBuffer;La4/c;)Ljava/lang/Object;
    .locals 18
    ...
    iput v4, v3, Ls8/u;->p:I

    goto :goto_0

    :cond_0
    new-instance v3, Ls8/u;

    invoke-direct {v3, v0, v2}, Ls8/u;-><init>(Ls8/x;La4/c;)V

    :goto_0
    iget-object v2, v3, Ls8/u;->n:Ljava/lang/Object;

    sget-object v4, Lz8/a;->g:Lz8/a;

    iget v5, v3, Ls8/u;->p:I
    ...
    iget v1, v3, Ls8/u;->m:I

    iget-object v5, v3, Ls8/u;->l:Li4/s;

    iget-object v7, v3, Ls8/u;->k:Ljava/nio/ByteBuffer;

    iget-object v8, v3, Ls8/u;->j:Ls8/x;
    ...
    iget-object v5, v0, Ls8/x;->l:Lba/fa;
    ...
    iget-object v5, v5, Lba/fa;->b:Ljava/lang/Object;
    ...
    iget-object v10, v7, Ls8/x;->k:Lu4/d;

    iget-object v11, v7, Ls8/x;->l:Lba/fa;

    if-nez v8, :cond_7

    if-nez v2, :cond_7

    iget-object v8, v11, Lba/fa;->b:Ljava/lang/Object;
    ...
    :cond_4
    instance-of v9, v8, Ls8/d;

    iget-object v10, v11, Lba/fa;->b:Ljava/lang/Object;
    ...
    iget-object v8, v11, Lba/fa;->c:Ljava/lang/Object;
    ...
    :cond_b
    iget-object v1, v7, Ls8/x;->g:Lio/ktor/utils/io/L;
    ...
    :cond_e
    :goto_7
    iget-boolean v8, v7, Ls8/x;->i:Z

    iput-boolean v8, v11, Lba/fa;->a:Z
    ...
    iput-object v9, v11, Lba/fa;->c:Ljava/lang/Object;
    ...
    :cond_10
    iget-boolean v14, v11, Lba/fa;->a:Z
    ...
    iput-object v10, v11, Lba/fa;->d:Ljava/lang/Object;

    goto :goto_a

    :cond_11
    iput-object v9, v11, Lba/fa;->d:Ljava/lang/Object;

    :goto_a
    iget-object v10, v13, Ls8/h;->g:Ljava/nio/ByteBuffer;
    ...
    :goto_d
    iget-object v15, v11, Lba/fa;->e:Ljava/lang/Object;

    check-cast v15, Ls8/l;

    iget-object v6, v13, Ls8/h;->b:Ls8/l;

    iget v9, v6, Ls8/l;->h:I

    iget-boolean v0, v13, Ls8/h;->a:Z

    if-nez v15, :cond_19

    if-nez v0, :cond_18

    iput-object v6, v11, Lba/fa;->e:Ljava/lang/Object;
    ...
    iput-object v15, v11, Lba/fa;->e:Ljava/lang/Object;
    ...
    :goto_14
    iget-object v0, v11, Lba/fa;->d:Ljava/lang/Object;
    ...
    invoke-static {v6, v0}, Lh7/b;->a0(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)V

    move-object v10, v6

    :cond_24
    iput-object v10, v11, Lba/fa;->c:Ljava/lang/Object;
    ...
    :cond_27
    iput-object v8, v5, Ls8/u;->j:Ls8/x;

    iput-object v1, v5, Ls8/u;->k:Ljava/nio/ByteBuffer;

    iput-object v3, v5, Ls8/u;->l:Li4/s;

    iput v2, v5, Ls8/u;->m:I

    const/4 v0, 0x1

    iput v0, v5, Ls8/u;->p:I

    iget-object v6, v8, Ls8/x;->g:Lio/ktor/utils/io/L;
    ...
    :cond_28
    :goto_16
    iget-object v6, v8, Ls8/x;->l:Lba/fa;
