...
.method public final A0(IZ)V
    ...
    invoke-static {v0}, Lq0/a0;->g(Lr5/p;)I

    move-result p1

    iput p1, v0, Lr5/p;->i:I

    :cond_2
    if-eqz v1, :cond_3

    iget-object p2, v1, Lr5/p;->l:Lr5/p;

    if-eqz p2, :cond_3

    iget p2, p2, Lr5/p;->j:I
    ...
    iget p2, v1, Lr5/p;->i:I

    or-int/2addr p1, p2

    iput p1, v1, Lr5/p;->j:I
...
.method public final o0()V
    ...
    invoke-super {p0}, Lr5/p;->o0()V

    iget-object v0, p0, Lq0/n;->u:Lr5/p;

    :goto_0
    if-eqz v0, :cond_1

    iget-object v1, p0, Lr5/p;->n:Lq0/Z1;
...
.method public final w0(Lr5/p;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lr5/p;->w0(Lr5/p;)V
...
.method public final x0(Lq0/Z1;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lr5/p;->x0(Lq0/Z1;)V
...
.method public final y0(Lq0/m;)V
    ...
    iget-object v1, p1, Lr5/p;->k:Lr5/p;

    :cond_1
    iget-object p1, p0, Lr5/p;->g:Lr5/p;
    ...
    :cond_5
    :goto_1
    iget-object v5, p0, Lq0/n;->u:Lr5/p;

    iput-object v5, v0, Lr5/p;->l:Lr5/p;

    iput-object v0, p0, Lq0/n;->u:Lr5/p;
    ...
    invoke-virtual {v2, v1}, Lr5/p;->x0(Lq0/Z1;)V
    ...
    :cond_7
    :goto_2
    iget-object p1, p0, Lr5/p;->n:Lq0/Z1;

    invoke-virtual {p0, p1}, Lq0/n;->x0(Lq0/Z1;)V
...
.method public final z0(Lq0/m;)V
    ...
    invoke-static {v0, p1, v3}, Lq0/a0;->b(Lr5/p;II)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {v0, v0}, Lr5/p;->w0(Lr5/p;)V

    const/4 p1, 0x0

    iput p1, v0, Lr5/p;->j:I

    if-nez v2, :cond_2

    iget-object p1, v0, Lr5/p;->l:Lr5/p;

    iput-object p1, p0, Lq0/n;->u:Lr5/p;
    ...
    iput-object p1, v2, Lr5/p;->l:Lr5/p;

    :goto_2
    iput-object v1, v0, Lr5/p;->l:Lr5/p;

    iput-object v1, v0, Lr5/p;->k:Lr5/p;
