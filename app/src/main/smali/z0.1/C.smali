...
# direct methods
.method public constructor <init>(Lz0/B;Lz0/l;J)V
    .locals 1
    ...
    iput-object p2, p0, Lz0/C;->b:Lz0/l;

    iput-wide p3, p0, Lz0/C;->c:J
    ...
    invoke-virtual {v0, p3}, LA0/G;->d(I)F

    move-result p3

    :goto_0
    iput p3, p0, Lz0/C;->d:F
    ...
    :cond_1
    invoke-static {p1}, LV3/k;->s0(Ljava/util/List;)Ljava/lang/Object;
    ...
    iget-object p3, p3, Lz0/a;->d:LA0/G;

    iget p4, p3, LA0/G;->g:I

    add-int/lit8 p4, p4, -0x1

    invoke-virtual {p3, p4}, LA0/G;->d(I)F
    ...
    :goto_1
    iput p4, p0, Lz0/C;->e:F

    iget-object p1, p2, Lz0/l;->g:Ljava/util/ArrayList;

    iput-object p1, p0, Lz0/C;->f:Ljava/util/ArrayList;
...
# virtual methods
.method public final a(I)LK0/f;
    .locals 2

    iget-object v0, p0, Lz0/C;->b:Lz0/l;

    invoke-virtual {v0, p1}, Lz0/l;->j(I)V

    iget-object v1, v0, Lz0/l;->a:LA0/s;

    iget-object v1, v1, LA0/s;->i:Ljava/lang/Object;
    ...
    iget-object v0, v1, Lz0/a;->d:LA0/G;
    ...
    sget-object p1, LK0/f;->h:LK0/f;

    goto :goto_1

    :cond_1
    sget-object p1, LK0/f;->g:LK0/f;

    :goto_1
    return-object p1
.end method

.method public final b(I)LX/d;
    .locals 9
    ...
    iget-object v1, v1, Lz0/a;->d:LA0/G;

    iget-object v2, v1, LA0/G;->f:Landroid/text/Layout;

    invoke-virtual {v2, p1}, Landroid/text/Layout;->getLineForOffset(I)I

    move-result v3

    invoke-virtual {v1, v3}, LA0/G;->g(I)F

    move-result v4

    invoke-virtual {v1, v3}, LA0/G;->e(I)F
    ...
    invoke-virtual {v1, p1, v6}, LA0/G;->h(IZ)F

    move-result v2

    add-int/2addr p1, v7

    invoke-virtual {v1, p1, v7}, LA0/G;->h(IZ)F
    ...
    invoke-virtual {v1, p1, v6}, LA0/G;->i(IZ)F

    move-result v2

    add-int/2addr p1, v7

    invoke-virtual {v1, p1, v7}, LA0/G;->i(IZ)F
    ...
    invoke-direct {v0, v6, p1, v2, v3}, LX/d;-><init>(FFFF)V
...
.method public final c(I)LX/d;
    ...
    invoke-virtual {v1, p1, v2}, LA0/G;->h(IZ)F

    move-result v2

    iget-object v3, v1, LA0/G;->f:Landroid/text/Layout;

    invoke-virtual {v3, p1}, Landroid/text/Layout;->getLineForOffset(I)I

    move-result p1

    invoke-virtual {v1, p1}, LA0/G;->g(I)F

    move-result v3

    invoke-virtual {v1, p1}, LA0/G;->e(I)F
    ...
    invoke-direct {v4, v5, v6, v3, v0}, LX/d;-><init>(FFFF)V
...
.method public final d(IZ)I
    ...
    iget-object p2, v1, LA0/G;->f:Landroid/text/Layout;
    ...
    invoke-virtual {v1}, LA0/G;->c()LA0/s;

    move-result-object p2

    iget-object v1, p2, LA0/s;->i:Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v1, p1}, LA0/G;->f(I)I
...
.method public final e(I)I
    ...
    iget-object v1, v1, LA0/G;->f:Landroid/text/Layout;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p1, Lz0/C;->a:Lz0/B;
    ...
    :cond_2
    iget-object v1, p0, Lz0/C;->b:Lz0/l;

    iget-object v3, p1, Lz0/C;->b:Lz0/l;
    ...
    :cond_3
    iget-wide v3, p0, Lz0/C;->c:J

    iget-wide v5, p1, Lz0/C;->c:J
    ...
    iget v3, p1, Lz0/C;->d:F

    cmpg-float v1, v1, v3

    if-nez v1, :cond_6

    iget v1, p0, Lz0/C;->e:F

    iget v3, p1, Lz0/C;->e:F

    cmpg-float v1, v1, v3

    if-nez v1, :cond_6

    iget-object v1, p0, Lz0/C;->f:Ljava/util/ArrayList;

    iget-object p1, p1, Lz0/C;->f:Ljava/util/ArrayList;
...
.method public final hashCode()I
    ...
    invoke-virtual {v0}, Lz0/B;->hashCode()I
    ...
    iget-object v2, p0, Lz0/C;->b:Lz0/l;
    ...
    iget v2, p0, Lz0/C;->d:F

    invoke-static {v2, v0, v1}, LA/m;->e(FII)I

    move-result v0

    iget v2, p0, Lz0/C;->e:F
...
.method public final j(II)LY/i;
    ...
    invoke-direct {v4, v1, p1, p2, v5}, LC/F;-><init>(Ljava/lang/Object;III)V
...
.method public final k(I)J
    ...
    invoke-virtual {v1}, LA0/G;->j()LB0/f;

    move-result-object v1

    invoke-virtual {v1, p1}, LB0/f;->a(I)V

    iget-object v2, v1, LB0/f;->e:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, LB0/f;->f(I)Z
    ...
    invoke-virtual {v1, v3}, LB0/f;->d(I)Z
    ...
    :cond_1
    invoke-virtual {v1, v3}, LB0/f;->a(I)V
    ...
    invoke-virtual {v1, p1}, LB0/f;->e(I)Z
    ...
    invoke-virtual {v1, p1}, LB0/f;->c(I)Z
    ...
    invoke-virtual {v1, v5}, LB0/f;->d(I)Z
    ...
    invoke-virtual {v1, v5}, LB0/f;->f(I)Z
    ...
    :cond_9
    invoke-virtual {v1, v5}, LB0/f;->a(I)V
