...
.field public z:Lxa/d;


# direct methods
.method public constructor <init>(Lo/oa;Lo/s0;ZLo/d;)V
    .locals 0

    invoke-direct {p0}, Lra/p;-><init>()V

    iput-object p1, p0, Lo/k;->t:Lo/oa;
...
.method public static final y0(Lo/k;Lo/d;)F
    ...
    invoke-static {v0, v1, v2, v3}, Ll5/j;->a(JJ)Z
    ...
    invoke-virtual {v6}, Lxa/d;->c()F

    move-result v7

    invoke-virtual {v6}, Lxa/d;->b()F
    ...
    invoke-static {v9, v10}, Ll9/d;->S(J)J

    move-result-wide v9

    iget-object v11, p0, Lo/k;->t:Lo/oa;
    ...
    invoke-static {v7, v8}, Lxa/f;->d(J)F
    ...
    invoke-virtual {p0}, Lo/k;->z0()Lxa/d;
    ...
    iget-object p0, p0, Lo/k;->t:Lo/oa;
    ...
    iget p0, v5, Lxa/d;->c:F

    iget v2, v5, Lxa/d;->a:F
    ...
    :cond_c
    iget p0, v5, Lxa/d;->d:F

    iget v2, v5, Lxa/d;->b:F
...
# virtual methods
.method public final A0(Lxa/d;J)Z
    .locals 1

    invoke-virtual {p0, p1, p2, p3}, Lo/k;->C0(Lxa/d;J)J
...
.method public final B0()V
    ...
    invoke-direct {v1, v2}, Lo/va0;-><init>(Ll/l;)V
    ...
    invoke-direct {v3, p0, v1, v0, v4}, Lo/j;-><init>(Lo/k;Lo/va0;Lo/d;Ly8/d;)V

    const/4 v0, 0x1

    const/4 v1, 0x4

    invoke-static {v2, v4, v1, v3, v0}, Ls4/y;->u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;
...
.method public final C0(Lxa/d;J)J
    .locals 3

    invoke-static {p2, p3}, Ll9/d;->S(J)J

    move-result-wide p2

    iget-object v0, p0, Lo/k;->t:Lo/oa;
...
.method public final y(J)V
    ...
    iget-object v2, p0, Lo/k;->t:Lo/oa;
    ...
    iget-object v4, p0, Lo/k;->z:Lxa/d;
    ...
    invoke-virtual {p0, v4, v0, v1}, Lo/k;->A0(Lxa/d;J)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {p0, v2, p1, p2}, Lo/k;->A0(Lxa/d;J)Z
    ...
    :cond_4
    iput-object v2, p0, Lo/k;->z:Lxa/d;

    :cond_5
    return-void
.end method

.method public final z0()Lxa/d;
    .locals 4
    ...
    invoke-virtual {v0, v2, v1}, Lq0/za;->X(Lo0/p;Z)Lxa/d;
