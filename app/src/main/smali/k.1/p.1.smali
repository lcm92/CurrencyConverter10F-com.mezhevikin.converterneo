...
.method public final d(Lo0/G;Ljava/util/List;J)Lo0/F;
    ...
    iget-object p3, v1, Lk/w;->a:LF/j0;

    invoke-static {p2, v2}, LL4/d;->b(II)J

    move-result-wide v3

    new-instance p4, LL0/j;

    invoke-direct {p4, v3, v4}, LL0/j;-><init>(J)V

    invoke-virtual {p3, p4}, LF/j0;->setValue(Ljava/lang/Object;)V
    ...
    :cond_a
    :goto_6
    new-instance p3, LA/S;

    const/4 p4, 0x4

    invoke-direct {p3, p4, v0}, LA/S;-><init>(ILjava/util/ArrayList;)V

    sget-object p4, LV3/u;->g:LV3/u;

    invoke-interface {p1, p2, v2, p4, p3}, Lo0/G;->K(IILjava/util/Map;Lh4/c;)Lo0/F;
