...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lu7/d;Lt7/b;)V
    .locals 0
    ...
    iput-object p2, p0, Lt7/d;->b:Lu7/d;

    iput-object p3, p0, Lt7/d;->c:Lt7/b;
...
.method public final a(Ln7/i;IZ)V
    ...
    iget-object v4, v1, Lt7/d;->a:Landroid/content/Context;
    ...
    iget-object v7, v0, Ln7/i;->c:Lk7/c;

    invoke-static {v7}, Lx7/a;->a(Lk7/c;)I
    ...
    :cond_2
    iget-object v10, v1, Lt7/d;->b:Lu7/d;

    check-cast v10, Lu7/h;

    invoke-virtual {v10}, Lu7/h;->b()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v12, v0, Ln7/i;->a:Ljava/lang/String;
    ...
    iget-object v3, v1, Lt7/d;->c:Lt7/b;

    invoke-virtual {v3, v7, v14, v15, v2}, Lt7/b;->a(Lk7/c;JI)J

    move-result-wide v0

    invoke-virtual {v10, v0, v1}, Landroid/app/job/JobInfo$Builder;->setMinimumLatency(J)Landroid/app/job/JobInfo$Builder;

    iget-object v0, v3, Lt7/b;->b:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lt7/c;->c:Ljava/util/Set;

    sget-object v1, Lt7/e;->g:Lt7/e;
