...
.method public constructor <init>(Lz4/c;)V
    ...
    invoke-static {p1, v0}, Lk4/a;->W(Ly8/g;Ly8/i;)Ly8/i;

    move-result-object p1

    iput-object p1, p0, Ly3/f;->m:Ly8/i;

    new-instance p1, Ly3/a;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Ly3/a;-><init>(Ly3/f;Ly8/d;)V

    const/4 v1, 0x3

    const/4 v2, 0x0

    invoke-static {p0, v0, v2, p1, v1}, Ls4/y;->u(Ls4/x;Ly8/i;ILh4/e;I)Ls4/ba;
...
.method public static i(Ljava/nio/channels/spi/AbstractSelector;Ljava/lang/Throwable;)V
    ...
    new-instance p1, Lfa/va;

    const-string v0, "Closed selector"

    const/16 v1, 0x8

    invoke-direct {p1, v0, v1}, Lfa/va;-><init>(Ljava/lang/String;I)V
...
.method public final b()Ly8/i;
    ...
    iget-object v0, p0, Ly3/f;->m:Ly8/i;
...
.method public final m(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-interface {v8, v9}, Ly8/d;->s(Ljava/lang/Object;)V
...
.method public final t(Ly3/p;Ly3/o;La4/c;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Ll9/d;->C(Ly8/d;)Ly8/d;

    move-result-object p3

    const/4 v1, 0x1

    invoke-direct {v0, v1, p3}, Ls4/f;-><init>(ILy8/d;)V
    ...
    :cond_0
    invoke-interface {p2, p3}, Ly8/d;->s(Ljava/lang/Object;)V
